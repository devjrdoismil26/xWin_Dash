/**
 * Serviço de Métricas de Analytics do SocialBuffer
 *
 * @description
 * Serviço responsável por métricas de analytics incluindo métricas básicas,
 * por plataforma, por post, séries temporais e conteúdo. Gerencia cache.
 *
 * @module modules/SocialBuffer/services/analytics/analyticsMetricsService
 * @since 1.0.0
 */

import { apiClient } from '@/services';
import { SocialAccount, SocialPost, SocialSchedule, SocialLink } from '../../types';
