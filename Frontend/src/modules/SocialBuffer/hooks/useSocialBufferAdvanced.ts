/**
 * Hook useSocialBufferAdvanced - Analytics Avan?ado do SocialBuffer
 *
 * @description
 * Hook para analytics avan?ado do SocialBuffer incluindo overview, m?tricas
 * por conta, por post, engajamento, alcance e impress?es. Gerencia filtros,
 * ordena??o e pagina??o.
 *
 * @module modules/SocialBuffer/hooks/useSocialBufferAdvanced
 * @since 1.0.0
 */

import { useState, useEffect, useCallback } from 'react';
import { socialBufferService } from '../services/socialBufferService';
import { SocialAnalyticsOverview, SocialAccountAnalytics, SocialPostAnalytics, SocialEngagementAnalytics, SocialReachAnalytics, SocialImpressionsAnalytics, SocialAnalyticsFilter, SocialAnalyticsSort, SocialAnalyticsPagination, UseSocialAnalyticsReturn, UseSocialAccountAnalyticsReturn, UseSocialPostAnalyticsReturn, UseSocialEngagementAnalyticsReturn, UseSocialReachAnalyticsReturn, UseSocialImpressionsAnalyticsReturn } from '../types/socialTypes';
