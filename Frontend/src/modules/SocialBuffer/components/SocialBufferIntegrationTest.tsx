        ...
        } },
    {
      ...
      action: async () => {
        try {
          ...
          return { success: false, message: 'Falha ao carregar contas', error: getErrorMessage(error)};
        ...
        } },
    {
      ...
      action: async () => {
        try {
          ...
          return { success: false, message: 'Falha ao criar post', error: getErrorMessage(error)};
        ...
        } },
    {
      ...
      action: async () => {
        try {
          ...
          return { success: false, message: 'Falha no agendamento', error: getErrorMessage(error)};
