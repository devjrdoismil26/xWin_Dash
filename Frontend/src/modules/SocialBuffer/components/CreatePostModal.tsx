...
const CreatePostModal: React.FC<CreatePostModalProps> = ({ isOpen, onClose    }) => {
  ...
  return (
            <div className=" ">$2</div><div className=" ">$2</div><div className=" ">$2</div><h2 className="text-xl font-semibold">Criar Novo Post</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6" />
          ...
          <div>
            ...
            <Input
              ...
              onChange={ (e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('scheduled_at', e.target.value) }
            ...
            <div className="{/* Hashtags */}">$2</div>
              <div>
                ...
                <Input
                  ...
                  onChange={ (e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('hashtags', e.target.value) }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={ (e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('media_url', e.target.value) }
                  placeholder="https://exemplo.com/imagem.jpg" />
              </div>
          )}
          {/* Botões */}
          <div className=" ">$2</div><Button type="button" variant="outline" onClick={ onClose } />
              Cancelar
            </Button>
            <Button
              type="submit"
