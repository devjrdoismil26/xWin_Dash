...
interface ThemeContextType {
  ...
  setTheme?: (e: any) => void;
  createCustomTheme?: (e: any) => void;
  updateTheme?: (e: any) => void;
  resetTheme??: (e: any) => void;
  exportTheme: () => string;
  importTheme?: (e: any) => void; }
...
export const ThemeSelector: React.FC<ThemeSelectorProps> = ({ className = ''    }) => {
  ...
  return (
      ...
      </div><label htmlFor="theme-select" className="block text-sm font-medium mb-2" />
        Tema
      </label>
      <select
        id="theme-select"
      ...
      >
        {(availableThemes || []).map((theme: unknown) => (
...
export const ThemePreview: React.FC<ThemePreviewProps> = ({ theme, className = ''    }) => {
  return (
      ...
      </div><div className=" ">$2</div><h3 style={color: theme.colors.primary, fontSize: theme.typography.fontSize.lg } />
          {theme.name}
        </h3>
