      ...
      immer((set: unknown, get: unknown) => ({
        ...
        fetchLeads: async (filters: LeadFilters = {}) => {
          ...
          try {
            ...
            const errorMessage = error instanceof Error
              ...
              : (error as { response?: { data?: { message?: string } })?.response?.data?.message || 'Erro ao carregar leads';
            set({ 
              error: errorMessage, 
              loading: false 
            });
        ...
        createLead: async (data: Partial<Lead>) => {
          ...
          try {
            ...
            const errorMessage = error instanceof Error
              ? getErrorMessage(error)
              : (error as { response?: { data?: { message?: string } })?.response?.data?.message || 'Erro ao criar lead';
            set({ 
              error: errorMessage, 
              loading: false 
            });
        ...
        updateLead: async (id: string, data: Partial<Lead>) => {
          ...
          try {
            ...
            const errorMessage = error instanceof Error
              ? getErrorMessage(error)
              : (error as { response?: { data?: { message?: string } })?.response?.data?.message || 'Erro ao atualizar lead';
            set({ 
              error: errorMessage, 
              loading: false 
            });
        ...
        deleteLead: async (id: string) => {
          ...
          try {
            ...
            const errorMessage = error instanceof Error
              ? getErrorMessage(error)
              : (error as { response?: { data?: { message?: string } })?.response?.data?.message || 'Erro ao excluir lead';
            set({ 
              error: errorMessage, 
              loading: false 
            });
        ...
        bulkUpdateLeads: async (ids: string[], updates: Partial<Lead>) => {
          ...
          try {
            ...
            const errorMessage = error instanceof Error
              ? getErrorMessage(error)
              : (error as { response?: { data?: { message?: string } })?.response?.data?.message || 'Erro ao atualizar leads em lote';
            set({ 
              error: errorMessage, 
              loading: false 
            });
        ...
        bulkDeleteLeads: async (ids: string[]) => {
          ...
          try {
            ...
            const errorMessage = error instanceof Error
              ? getErrorMessage(error)
              : (error as { response?: { data?: { message?: string } })?.response?.data?.message || 'Erro ao excluir leads em lote';
            set({ 
              error: errorMessage, 
              loading: false 
            });
