...
jest.mock('../LeadsManager/components/ModernLeadCard', () => {
  return function MockModernLeadCard({ lead, onView, onEdit, onDelete }: unknown) {
    return (
        <>
...
jest.mock('../LeadsManager/components/ModernLeadFilters', () => {
  return function MockModernLeadFilters({ onApplyFilters, onClearFilters }: unknown) {
    return (
        <>
      <div data-testid="lead-filters">
      </div><button onClick={() => onApplyFilters({ status: ['new'] })}>Apply Filters</button>
...
jest.mock('../LeadsAnalytics/components/ModernLeadAnalytics', () => {
  return function MockModernLeadAnalytics({ analytics, metrics }: unknown) {
    return (
        <>
...
jest.mock('@/layouts/AppLayout', () => {
  return function MockAppLayout({ children }: unknown) {
