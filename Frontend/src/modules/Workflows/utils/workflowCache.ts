/**
 * Sistema de Cache para Workflows
 *
 * @description
 * Sistema de cache inteligente para workflows com TTL configurável,
 * invalidação automática, estatísticas e invalidação por tags.
 * Implementa cache em memória com gerenciamento avançado.
 *
 * @module modules/Workflows/utils/workflowCache
 * @since 1.0.0
 */
