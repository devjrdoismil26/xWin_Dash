...
export const useMetricsStore = create<MetricsStore>()(
  devtools(
    (set: unknown, get: unknown) => ({
      ...
      fetchWorkflowMetrics: async (params: unknown) => {
        ...
        try {
          ...
          set({
            error: getErrorMessage(error) + 'Erro ao carregar métricas de workflows',
            isLoadingWorkflowMetrics: false
          });

        } ,

      fetchExecutionStats: async (params: unknown) => {
        ...
        try {
          ...
          set({
            error: getErrorMessage(error) + 'Erro ao carregar estatísticas de execuções',
            isLoadingExecutionStats: false
          });

        } ,

      fetchPerformanceData: async (params: unknown) => {
        ...
        try {
          ...
          set({
            error: getErrorMessage(error) + 'Erro ao carregar dados de performance',
            isLoadingPerformanceMetrics: false
          });
      ...
      fetchSystemMetrics: async () => {
        ...
        try {
          ...
          set({
            error: getErrorMessage(error) + 'Erro ao carregar métricas de sistema',
            isLoadingSystemMetrics: false
          });

        } ,

      fetchPerformanceReport: async (params: unknown) => {
        ...
        try {
          ...
          set({
            error: getErrorMessage(error) + 'Erro ao carregar relatório de performance',
            isLoadingPerformanceReport: false
          });
      ...
      fetchRealTimeMetrics: async () => {
        ...
        try {
          ...
          set({
            error: getErrorMessage(error) + 'Erro ao carregar métricas em tempo real',
            isLoadingRealTimeMetrics: false
          });

        } ,

      fetchExecutionTrends: async (params: unknown) => {
        ...
        try {
          ...
          set({
            error: getErrorMessage(error) + 'Erro ao carregar tendências de execução',
            isLoadingExecutionTrends: false
          });
      ...
      fetchWorkflowMetricsById: async (workflowId: unknown, params: unknown) => {
      ...
      fetchWorkflowExecutionStats: async (workflowId: unknown, params: unknown) => {
      ...
      fetchWorkflowPerformanceData: async (workflowId: unknown, params: unknown) => {
      ...
      refreshAllMetrics: async () => {
        ...
        try {
          ...
          set({
            error: getErrorMessage(error) + 'Erro ao atualizar métricas',
            loading: false
          });
