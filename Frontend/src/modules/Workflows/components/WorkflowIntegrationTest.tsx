        ...
        } },
    {
      ...
      action: async () => {
        try {
          ...
          return { success: false, message: 'Falha ao criar workflow', error: (error as any).message};
        ...
        } },
    {
      ...
      action: async () => {
        try {
          ...
          return { success: false, message: 'Falha na execução do workflow', error: (error as any).message};
        ...
        } },
    {
      ...
      action: async () => {
        try {
          ...
          return { success: false, message: 'Falha ao carregar nós', error: (error as any).message};
