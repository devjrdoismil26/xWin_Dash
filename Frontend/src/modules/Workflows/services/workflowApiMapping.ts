...
// ===== UTILITY FUNCTIONS =====
export const buildApiUrl = (endpoint: ApiEndpoint, parameters: Record<string, any> = {}): string => {
...
export const buildQueryString = (endpoint: ApiEndpoint, parameters: Record<string, any> = {}): string => {
...
export const validateEndpointParameters = (endpoint: ApiEndpoint, parameters: Record<string, any>): EndpointValidation => {
  const errors: string[] = [];
