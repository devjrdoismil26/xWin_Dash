...
describe("Activity Service Integration Tests", () => {
  ...
  describe("getLogs", () => {
    it("should fetch logs successfully with cache", async () => {
      ...
      // Mock cache miss
      require("../services/activityCacheService").getCachedLogs.mockReturnValue(
        null,);
      ...
      expect(
        require("../services/activityCacheService").cacheLogs,
      ).toHaveBeenCalledWith(mockFilters, mockLogs);
    ...
    it("should return cached logs when available", async () => {
      ...
      expect(
        require("../services/activityApiService").getLogs,
  ...
  describe("getLogById", () => {
    it("should fetch log by ID successfully", async () => {
      ...
      // Mock cache miss
      require("../services/activityCacheService").getCachedLog.mockReturnValue(
        null,);
    ...
    it("should handle invalid log ID", async () => {
      // Mock validation failure
      require("../services/activityValidationService").validateLogId.mockReturnValue(
        false,);
  ...
  describe("getLogStats", () => {
    it("should fetch stats successfully", async () => {
      ...
      // Mock cache miss
      require("../services/activityCacheService").getCachedStats.mockReturnValue(
        null,);
  ...
  describe("exportLogs", () => {
    ...
    it("should handle invalid export format", async () => {
      ...
      // Mock validation failure
      require("../services/activityValidationService").validateExportFormat.mockReturnValue(
        false,);
  ...
  describe("clearOldLogs", () => {
    it("should clear old logs successfully", async () => {
      ...
      expect(
        require("../services/activityCacheService").invalidateLogsCache,
      ).toHaveBeenCalled();
  ...
  describe("utility methods", () => {
    ...
    it("should clear cache", () => {
      ...
      expect(
        require("../services/activityCacheService").clear,
      ).toHaveBeenCalled();
    ...
    it("should get cache info", () => {
      ...
      require("../services/activityCacheService").getCacheInfo.mockReturnValue(
        mockCacheInfo,);
