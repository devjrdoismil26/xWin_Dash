...
export const LazyLoading: React.FC<LazyLoadingProps> = ({ size = 'md',
  ...
  return (
      ...
      </div><div className=" ">$2</div><LoadingSpinner size={size} / />
...
> {
  ...
  render() {
    if (this.state.hasError) {
      return (
                <div className=" ">$2</div><div className=" ">$2</div><svg className="w-12 h-12 mx-auto mb-4 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.732-.833-2.5 0L4.268 18.5c-.77.833.192 2.5 1.732 2.5z" / /></svg><h3 className="text-lg font-semibold text-gray-900 mb-2" />
...
class ComponentPreloader {
  ...
  private preloadQueue: Array<() => Promise<any>> = [] as unknown[];
...
export const SmartLazy: React.FC<SmartLazyProps> = ({ component: Component,
  fallback = <LazyLoading />,
...
export { componentPreloader, ErrorBoundary };
