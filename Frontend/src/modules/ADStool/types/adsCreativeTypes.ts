 ...
 * @module modules/ADStool/types/adsCreativeTypes
 * @description
 * Definições de tipos e interfaces para criativos de anúncios, incluindo
 * estruturas de dados, tipos, status, conteúdo, imagens, vídeos, links, mídia,
 * textos, assets, templates, variações, testes, aprovações, performance, insights,
 * otimizações, audiências, placements, dispositivos, localizações, horários,
 * demografia, interesses, comportamentos, remarketing, frequência, rotação,
 * entrega, lances, orçamentos, agendamentos, extensões, conversões, alertas,
 * histórico, rascunhos, experimentos, validações, previews, backups, auditorias,
 * conformidade, uso de API, custos e metas.
 * @since 1.0.0
 */

/**
 * Interface AdsCreative - Criativo de Anúncios
 * @interface AdsCreative
 * @description
 * Representa um criativo de anúncios no sistema, contendo informações
 * sobre a campanha associada, tipo, status, conteúdo e timestamps.
 */
