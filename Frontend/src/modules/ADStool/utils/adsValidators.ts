/**
 * Validadores do ADStool
 *
 * @description
 * Funções de validação para o módulo ADStool incluindo validação
 * de strings, emails, URLs, números e outras validações comuns.
 *
 * @module modules/ADStool/utils/adsValidators
 * @since 1.0.0
 */
 ...
 *
 * @description
 * Verifica se uma string não está vazia após remoção de espaços.
 *
 ...
 */
export const isNonEmptyArray = (array: string[]): boolean => {
  return Array.isArray(array) && array.length > 0;};

/**
 * Valida objeto não vazio
 */
export const isNonEmptyObject = (obj: unknown): boolean => {
