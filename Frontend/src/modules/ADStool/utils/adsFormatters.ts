/**
 * Formatadores do ADStool
 *
 * @description
 * Funções de formatação para dados do ADStool incluindo moeda,
 * números, percentuais, datas e outras formatações.
 *
 * @module modules/ADStool/utils/adsFormatters
 * @since 1.0.0
 */
...
export const formatDate = (date: string | Date, format: 'short' | 'long' | 'time' = 'short'): string => {
  ...
  const options: Intl.DateTimeFormatOptions = {
    ...
    time: { hour: '2-digit', minute: '2-digit' } [format];
