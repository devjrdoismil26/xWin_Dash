...
interface IndexProps {
  ...
  onClick?: (e: any) => void;
  onChange?: (e: any) => void; }
const Index: React.FC<IndexProps> = ({ campaigns = [] as unknown[]    }) => { return (
        <>
      <AuthenticatedLayout />
  ...
  >
        <CampaignTable
          ...
          onViewDetails={ (c: Campaign) => router.visit(route('adstool.campaigns.show', c.id)) } /></PageLayout></AuthenticatedLayout>);};
