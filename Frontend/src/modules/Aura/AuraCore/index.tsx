...
const AuraDashboard = React.lazy(() => import('./shared/components/AuraDashboard'));
...
const AuraConnections = React.lazy(() => import('../shared/components/ConnectionManager'));
...
const AuraCore: React.FC<AuraCoreProps> = ({ auth, 
  page = 'index', 
  id,
  className 
   }) => { const renderContent = () => {
...
const AuraCoreIndex: React.FC<{ auth?: string }> = ({ auth    }) => {
