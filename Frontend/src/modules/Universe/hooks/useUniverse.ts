...
export const useUniverse = () => {
  ...
  const fetchInstances = useCallback(async () => {
    ...
    try {
      const response = await apiClient.get('/api/v1/universe', {
        method: 'GET',
        headers: {
  ...
  const fetchSnapshots = useCallback(async (instanceId?: number) => {
    try {
      ...
      const response = await apiClient.get(`/api/v1/universe/snapshots?${params}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const fetchTemplates = useCallback(async () => {
    try {
      const response = await apiClient.get('/api/v1/universe/templates', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const fetchStats = useCallback(async () => {
    try {
      const response = await apiClient.get('/api/v1/universe/stats', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const updateInstance = useCallback(async (id: number, data: Partial<UniverseInstance>) => {
    try {
      const response = await apiClient.get(`/api/v1/universe/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const createSnapshot = useCallback(async (data: Partial<UniverseSnapshot>) => {
    try {
      const response = await apiClient.get('/api/v1/universe/snapshots', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const deleteSnapshot = useCallback(async (id: number) => {
    try {
      const response = await apiClient.get(`/api/v1/universe/snapshots/${id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const startInstance = useCallback(async (id: number) => {
    try {
      const response = await apiClient.get(`/api/v1/universe/${id}/start`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const stopInstance = useCallback(async (id: number) => {
    try {
      const response = await apiClient.get(`/api/v1/universe/${id}/stop`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const saveInstance = useCallback(async (id: number) => {
    ...
    try {
      const response = await apiClient.get(`/api/v1/universe/${id}/save`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
