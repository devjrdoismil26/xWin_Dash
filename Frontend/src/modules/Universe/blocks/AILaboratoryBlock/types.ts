...
export const VALIDATION_RULES: unknown = {
  image: { 
    maxWidth: 2048, 
    maxHeight: 2048,
    maxSteps: 100,
...
export const DEFAULT_AI_CONFIG: unknown = {
...
export const DEFAULT_GENERATION_CONFIG: unknown = {
  image: {
...
export const ERROR_CODES: unknown = {
