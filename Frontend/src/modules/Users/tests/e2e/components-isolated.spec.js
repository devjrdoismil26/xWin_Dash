...
test.describe("Componentes de Usuários - Testes Isolados", () => {
    ...
    test("deve ter componente LoginForm funcionando", async ({ page }) => {
      const loginFormElements = await page.evaluate(() => {
        return {
          ...
          hasRememberCheckbox: !!document.querySelector(
            'input[name="remember"]',
          ),
          ...
          emailInput: {
            ...
            hasIcon:
              !!document.querySelector(
                'input[name="email"] + svg, input[name="email"]',
              ).previousElementSibling?.tagName === "svg",
            hasPlaceholder: !!document.querySelector('input[name="email"]')
              ?.placeholder,
            hasValidation: !!document.querySelector('input[name="email"]')
              ?.required,
          },
          passwordInput: {
            ...
            hasIcon:
              !!document.querySelector(
                'input[name="password"] + svg, input[name="password"]',
              ).previousElementSibling?.tagName === "svg",
            hasPlaceholder: !!document.querySelector('input[name="password"]')
              ?.placeholder,
            hasValidation: !!document.querySelector('input[name="password"]')
              ?.required,
          },
        };
      });
        ...
        return {
          submitButton: {
            ...
            hasText:
              ...
              "",
            hasClass:
              document.querySelector('button[type="submit"]')?.className || "",
            isDisabled:
      ...
      const checkboxElements = await page.evaluate(() => {
        return {
          ...
          hasLabel: !!document.querySelector(
            'input[name="remember"] + span, label:has(input[name="remember"])',
          ),
          hasText:
            document.querySelector('input[name="remember"] + span')
              ?.textContent || "",
          isChecked:
            document.querySelector('input[name="remember"]')?.checked || false,
          checkboxType:
            document.querySelector('input[name="remember"]')?.type || "",
        };
      });
  ...
  test.describe("Componentes de Cadastro", () => {
    ...
    test("deve ter componente RegisterForm funcionando", async ({ page }) => {
      const registerFormElements = await page.evaluate(() => {
        return {
          ...
          hasEmailField: !!document.querySelector('input[name="email"]'),
          hasPasswordField: !!document.querySelector('input[name="password"]'),
          hasPasswordConfirmationField: !!document.querySelector(
            'input[name="password_confirmation"]',
          ),
          hasSubmitButton: !!document.querySelector('button[type="submit"]'),
          hasPasswordToggles: document.querySelectorAll('button[type="button"]')
            .length,
          totalFormElements: document.querySelectorAll("form *").length,
        };
      });
    ...
    test("deve ter validação de confirmação de senha", async ({ page }) => {
      ...
      expect(
        passwordValidationElements.hasPasswordConfirmationField,
      ).toBeTruthy();
    });
  });
  ...
  test.describe("Componentes de Gerenciamento", () => {
    ...
    test("deve ter componente UserCard funcionando", async ({ page }) => {
      const cardElements = await page.evaluate(() => {
        return {
          hasCards: document.querySelectorAll(
            '[class*="card"], [data-testid*="card"]',
          ).length,
          hasUserCards: document.querySelectorAll(
            '[class*="user-card"], [data-testid*="user-card"]',
          ).length,
          hasCardHeaders: document.querySelectorAll(
            '[class*="card-header"], [data-testid*="card-header"]',
          ).length,
          hasCardContent: document.querySelectorAll(
            '[class*="card-content"], [data-testid*="card-content"]',
          ).length,
          hasCardActions: document.querySelectorAll(
            '[class*="card-actions"], [data-testid*="card-actions"]',
          ).length,
          totalCardElements: document.querySelectorAll(
            '[class*="card"], [data-testid*="card"]',
          ).length,
        };
      });
    ...
    test("deve ter componente UserStats funcionando", async ({ page }) => {
      const statsElements = await page.evaluate(() => {
        return {
          hasStats: !!document.querySelector(
            '[data-testid*="stats"], [class*="stats"]',
          ),
          hasStatCards: document.querySelectorAll(
            '[data-testid*="stat-card"], [class*="stat-card"]',
          ).length,
          hasStatNumbers: document.querySelectorAll(
            '[data-testid*="stat-number"], [class*="stat-number"]',
          ).length,
          hasStatLabels: document.querySelectorAll(
            '[data-testid*="stat-label"], [class*="stat-label"]',
          ).length,
          hasStatCharts: document.querySelectorAll(
            '[data-testid*="chart"], [class*="chart"], canvas',
          ).length,
          totalStatsElements: document.querySelectorAll(
    ...
    test("deve ter componente UserFilters funcionando", async ({ page }) => {
      const filterElements = await page.evaluate(() => {
        return {
          ...
          hasClearButton: !!document.querySelector(
            'button[data-testid*="clear"], [class*="clear"]',
          ),
          totalFilterElements: document.querySelectorAll(
            '[data-testid*="filter"], [class*="filter"]',
          ).length,
        };
      });
  ...
  test.describe("Componentes de Perfil", () => {
    ...
    test("deve ter componente UserProfile funcionando", async ({ page }) => {
      const profileElements = await page.evaluate(() => {
        return {
          ...
          hasName: !!document.querySelector(
            '[data-testid*="name"], [class*="name"]',
          ),
          hasEmail: !!document.querySelector(
            '[data-testid*="email"], [class*="email"]',
          ),
          hasBio: !!document.querySelector(
            '[data-testid*="bio"], [class*="bio"]',
          ),
          hasEditButton: !!document.querySelector(
            'button[data-testid*="edit"], [class*="edit"]',
          ),
          totalProfileElements: document.querySelectorAll(
            '[data-testid*="profile"], [class*="profile"]',
          ).length,
        };
      });
    ...
    test("deve ter componente UserPreferences funcionando", async ({
      page,
    }) => {
      const preferencesElements = await page.evaluate(() => {
        return {
          hasPreferences: !!document.querySelector(
            '[data-testid*="preferences"], [class*="preferences"]',
          ),
          hasThemeToggle: !!document.querySelector(
            '[data-testid*="theme"], [class*="theme"]',
          ),
          hasLanguageSelect: !!document.querySelector(
            'select[name*="language"], [data-testid*="language"]',
          ),
          hasTimezoneSelect: !!document.querySelector(
            'select[name*="timezone"], [data-testid*="timezone"]',
          ),
          hasNotificationSettings: !!document.querySelector(
            '[data-testid*="notification"], [class*="notification"]',
          ),
          totalPreferencesElements: document.querySelectorAll(
            '[data-testid*="preference"], [class*="preference"]',
          ).length,
        };
      });
    ...
    test("deve ter componente UserActivity funcionando", async ({ page }) => {
      const activityElements = await page.evaluate(() => {
        return {
          hasActivity: !!document.querySelector(
            '[data-testid*="activity"], [class*="activity"]',
          ),
          hasActivityList: !!document.querySelector(
            '[data-testid*="activity-list"], [class*="activity-list"]',
          ),
          hasActivityItems: document.querySelectorAll(
            '[data-testid*="activity-item"], [class*="activity-item"]',
          ).length,
          hasTimeline: !!document.querySelector(
            '[data-testid*="timeline"], [class*="timeline"]',
          ),
          hasActivityFilters: !!document.querySelector(
            '[data-testid*="activity-filter"], [class*="activity-filter"]',
          ),
          totalActivityElements: document.querySelectorAll(
            '[data-testid*="activity"], [class*="activity"]',
          ).length,
        };
      });
  ...
  test.describe("Componentes de Notificação", () => {
    ...
    test("deve ter componente NotificationSystem funcionando", async ({
      page,
    }) => {
      const notificationElements = await page.evaluate(() => {
        return {
          hasNotificationSystem: !!document.querySelector(
            '[data-testid*="notification-system"], [class*="notification-system"]',
          ),
          hasNotificationList: !!document.querySelector(
            '[data-testid*="notification-list"], [class*="notification-list"]',
          ),
          hasNotificationItems: document.querySelectorAll(
            '[data-testid*="notification-item"], [class*="notification-item"]',
          ).length,
          hasNotificationBell: !!document.querySelector(
            '[data-testid*="notification-bell"], [class*="notification-bell"]',
          ),
          hasNotificationBadge: !!document.querySelector(
            '[data-testid*="notification-badge"], [class*="notification-badge"]',
          ),
          totalNotificationElements: document.querySelectorAll(
            '[data-testid*="notification"], [class*="notification"]',
          ).length,
        };
      });
    ...
    test("deve ter componente NotificationItem funcionando", async ({
      page,
    }) => {
      const notificationItemElements = await page.evaluate(() => {
        return {
          ...
          hasNotificationTitle: !!document.querySelector(
            '[data-testid*="notification-title"], [class*="notification-title"]',
          ),
          hasNotificationMessage: !!document.querySelector(
            '[data-testid*="notification-message"], [class*="notification-message"]',
          ),
          hasNotificationTime: !!document.querySelector(
            '[data-testid*="notification-time"], [class*="notification-time"]',
          ),
          hasNotificationActions: !!document.querySelector(
            '[data-testid*="notification-actions"], [class*="notification-actions"]',
          ),
          hasNotificationClose: !!document.querySelector(
            '[data-testid*="notification-close"], [class*="notification-close"]',
          ),
        };
      });
  ...
  test.describe("Componentes de Formulário", () => {
    ...
    test("deve ter componente Form funcionando", async ({ page }) => {
      const formElements = await page.evaluate(() => {
        return {
          hasForm: !!document.querySelector("form"),
          hasFormFields: document.querySelectorAll("input, textarea, select")
            .length,
          hasFormValidation: document.querySelectorAll(
            "input[required], textarea[required], select[required]",
          ).length,
          hasFormActions: document.querySelectorAll(
            'button[type="submit"], button[type="button"]',
          ).length,
          hasFormErrors: document.querySelectorAll(
    ...
    test("deve ter componente FormField funcionando", async ({ page }) => {
      const formFieldElements = await page.evaluate(() => {
        return {
          ...
          hasErrorMessages: document.querySelectorAll(
            '[data-testid*="error"], [class*="error"]',
          ).length,
          hasHelpText: document.querySelectorAll(
            '[data-testid*="help"], [class*="help"]',
          ).length,
          totalFormFields: document.querySelectorAll("input, textarea, select")
            .length,
        };
      });
      ...
      const formActionElements = await page.evaluate(() => {
        return {
          ...
          hasCancelButton: !!document.querySelector(
            'button[data-testid*="cancel"], [class*="cancel"]',
          ),
  ...
  test.describe("Componentes de Modal", () => {
    ...
    test("deve ter componente Modal funcionando", async ({ page }) => {
      const modalElements = await page.evaluate(() => {
        return {
          hasModals: document.querySelectorAll(
            '[data-testid*="modal"], [class*="modal"], [role="dialog"]',
          ).length,
          hasModalOverlay: !!document.querySelector(
            '[data-testid*="modal-overlay"], [class*="modal-overlay"]',
          ),
          hasModalContent: !!document.querySelector(
            '[data-testid*="modal-content"], [class*="modal-content"]',
          ),
          hasModalHeader: !!document.querySelector(
            '[data-testid*="modal-header"], [class*="modal-header"]',
          ),
          hasModalBody: !!document.querySelector(
            '[data-testid*="modal-body"], [class*="modal-body"]',
          ),
          hasModalFooter: !!document.querySelector(
            '[data-testid*="modal-footer"], [class*="modal-footer"]',
          ),
          hasModalClose: !!document.querySelector(
            '[data-testid*="modal-close"], [class*="modal-close"]',
          ),
        };
      });
    ...
    test("deve ter componente ConfirmDialog funcionando", async ({ page }) => {
      const confirmDialogElements = await page.evaluate(() => {
        return {
          hasConfirmDialogs: document.querySelectorAll(
            '[data-testid*="confirm"], [class*="confirm"]',
          ).length,
          hasConfirmTitle: !!document.querySelector(
            '[data-testid*="confirm-title"], [class*="confirm-title"]',
          ),
          hasConfirmMessage: !!document.querySelector(
            '[data-testid*="confirm-message"], [class*="confirm-message"]',
          ),
          hasConfirmActions: !!document.querySelector(
            '[data-testid*="confirm-actions"], [class*="confirm-actions"]',
          ),
          hasConfirmButton: !!document.querySelector(
            'button[data-testid*="confirm"], [class*="confirm"]',
          ),
          hasCancelButton: !!document.querySelector(
            'button[data-testid*="cancel"], [class*="cancel"]',
          ),
  ...
  test.describe("Componentes de Loading", () => {
    ...
    test("deve ter componente Loading funcionando", async ({ page }) => {
      const loadingElements = await page.evaluate(() => {
        return {
          hasLoadingSpinners: document.querySelectorAll(
            '[data-testid*="loading"], [class*="loading"], [class*="spinner"]',
          ).length,
          hasLoadingSkeletons: document.querySelectorAll(
            '[data-testid*="skeleton"], [class*="skeleton"]',
          ).length,
          hasLoadingOverlays: document.querySelectorAll(
            '[data-testid*="loading-overlay"], [class*="loading-overlay"]',
          ).length,
          hasLoadingText: !!document.querySelector(
            '[data-testid*="loading-text"], [class*="loading-text"]',
          ),
          totalLoadingElements: document.querySelectorAll(
    ...
    test("deve ter componente Skeleton funcionando", async ({ page }) => {
      const skeletonElements = await page.evaluate(() => {
        return {
          hasSkeletons: document.querySelectorAll(
            '[data-testid*="skeleton"], [class*="skeleton"]',
          ).length,
          hasSkeletonText: document.querySelectorAll(
            '[data-testid*="skeleton-text"], [class*="skeleton-text"]',
          ).length,
          hasSkeletonImage: document.querySelectorAll(
            '[data-testid*="skeleton-image"], [class*="skeleton-image"]',
          ).length,
          hasSkeletonButton: document.querySelectorAll(
            '[data-testid*="skeleton-button"], [class*="skeleton-button"]',
          ).length,
          hasSkeletonCard: document.querySelectorAll(
            '[data-testid*="skeleton-card"], [class*="skeleton-card"]',
          ).length,
        };
      });
  ...
  test.describe("Responsividade dos Componentes", () => {
    ...
    for (const viewport of viewports) {
      test(`deve ter componentes responsivos em ${viewport.name}`, async ({
        page,
      }) => {
        ...
        for (const pagePath of pages) {
          ...
          const componentInfo = await page.evaluate(() => {
            return {
              hasResponsiveElements: document.querySelectorAll(
                '[class*="sm:"], [class*="md:"], [class*="lg:"], [class*="xl:"]',
              ).length,
              hasFlexElements:
                document.querySelectorAll('[class*="flex"]').length,
              hasGridElements:
                document.querySelectorAll('[class*="grid"]').length,
              hasResponsiveText: document.querySelectorAll(
                '[class*="text-sm"], [class*="text-md"], [class*="text-lg"]',
              ).length,
          ...
          console.log(
            `Componentes em ${pagePath} (${viewport.name}):`,
            componentInfo,
          );
      ...
      const accessibilityElements = await page.evaluate(() => {
        return {
          ...
          hasHeadings: document.querySelectorAll("h1, h2, h3, h4, h5, h6")
            .length,
          hasFocusableElements: document.querySelectorAll(
