...
test.describe("Perfil de Usuário", () => {
  ...
  test("deve ter formulário de edição de perfil", async ({ page }) => {
    ...
    const editElements = page.locator(
      '[data-testid*="edit"], [class*="edit"], [id*="edit"]',
    );
  ...
  test("deve ter preferências do usuário", async ({ page }) => {
    ...
    const preferenceElements = page.locator(
      '[data-testid*="preference"], [class*="preference"], [id*="preference"]',
    );
  ...
  test("deve ter configurações de usuário", async ({ page }) => {
    ...
    const settingsElements = page.locator(
      '[data-testid*="setting"], [class*="setting"], [id*="setting"]',
    );
  ...
  test("deve ter informações pessoais", async ({ page }) => {
    ...
    const personalInfoElements = page.locator(
  ...
  test("deve ter upload de avatar", async ({ page }) => {
    ...
    const uploadElements = page.locator(
      'input[type="file"], [data-testid*="upload"], [class*="upload"]',
    );
  ...
  test("deve ter alteração de senha", async ({ page }) => {
    ...
    const passwordElements = page.locator(
      'input[name*="password"], [data-testid*="password"], [class*="password"]',
    );
  ...
  test("deve ter histórico de atividades", async ({ page }) => {
    ...
    const historyElements = page.locator(
      '[data-testid*="history"], [class*="history"], [id*="history"]',
    );
  ...
  test("deve ter configurações de privacidade", async ({ page }) => {
    ...
    const privacyElements = page.locator(
      '[data-testid*="privacy"], [class*="privacy"], [id*="privacy"]',
    );
  ...
  test("deve ter configurações de segurança", async ({ page }) => {
    ...
    const securityElements = page.locator(
      '[data-testid*="security"], [class*="security"], [id*="security"]',
    );
  ...
  test("deve ter configurações de idioma", async ({ page }) => {
    ...
    const languageElements = page.locator(
      '[data-testid*="language"], [class*="language"], [id*="language"]',
    );
  ...
  test("deve ter configurações de timezone", async ({ page }) => {
    ...
    const timezoneElements = page.locator(
      '[data-testid*="timezone"], [class*="timezone"], [id*="timezone"]',
    );
  ...
  test("deve ter configurações de email", async ({ page }) => {
    ...
    const emailSettingsElements = page.locator(
  ...
  test("deve ter configurações de SMS", async ({ page }) => {
    ...
    const smsElements = page.locator(
      '[data-testid*="sms"], [class*="sms"], [id*="sms"]',
    );
  ...
  test("deve ter configurações de push", async ({ page }) => {
    ...
    const pushElements = page.locator(
      '[data-testid*="push"], [class*="push"], [id*="push"]',
    );
  ...
  test("deve ter configurações de webhook", async ({ page }) => {
    ...
    const webhookElements = page.locator(
      '[data-testid*="webhook"], [class*="webhook"], [id*="webhook"]',
    );
  ...
  test("deve ter configurações de API", async ({ page }) => {
    ...
    const apiElements = page.locator(
      '[data-testid*="api"], [class*="api"], [id*="api"]',
    );
  ...
  test("deve ter configurações de integração", async ({ page }) => {
    ...
    const integrationElements = page.locator(
      '[data-testid*="integration"], [class*="integration"], [id*="integration"]',
    );
  ...
  test("deve ter configurações de backup", async ({ page }) => {
    ...
    const backupElements = page.locator(
      '[data-testid*="backup"], [class*="backup"], [id*="backup"]',
    );
  ...
  test("deve ter configurações de exportação", async ({ page }) => {
    ...
    const exportElements = page.locator(
      '[data-testid*="export"], [class*="export"], [id*="export"]',
    );
  ...
  test("deve ter configurações de importação", async ({ page }) => {
    ...
    const importElements = page.locator(
      '[data-testid*="import"], [class*="import"], [id*="import"]',
    );
