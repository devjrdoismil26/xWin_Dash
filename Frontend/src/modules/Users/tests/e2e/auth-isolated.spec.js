...
test.describe("Autenticação - Testes Isolados", () => {
  test.describe("Página de Login", () => {
    ...
    test("deve exibir todos os elementos do formulário de login", async ({
      page,
    }) => {
  ...
  test.describe("Página de Cadastro", () => {
    ...
    test("deve carregar a página de cadastro corretamente", async ({
      page,
    }) => {
      await expect(page).toHaveURL(/.*register/);
    ...
    test("deve exibir todos os elementos do formulário de cadastro", async ({
      page,
    }) => {
    ...
    test("deve ter placeholders apropriados", async ({ page }) => {
      ...
      await expect(
        page.locator('input[name="password_confirmation"]'),
      ).toHaveAttribute("placeholder", "Confirme sua senha");
    });
  ...
  test.describe("Página de Recuperação de Senha", () => {
    ...
    test("deve carregar a página de recuperação corretamente", async ({
      page,
    }) => {
      await expect(page).toHaveURL(/.*password\.request/);
    });
  ...
  test.describe("Página de Confirmação de Senha", () => {
    ...
    test("deve carregar a página de confirmação corretamente", async ({
      page,
    }) => {
  ...
  test.describe("Página de Verificação de Email", () => {
    ...
    test("deve carregar a página de verificação corretamente", async ({
      page,
    }) => {
  ...
  test.describe("Navegação entre Páginas", () => {
    ...
    test("deve navegar de login para recuperação de senha", async ({
      page,
    }) => {
      await page.goto("/login");
      await page.click('a[href*="password.request"]');
