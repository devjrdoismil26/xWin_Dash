...
class SettingsCacheService {
   ...
   */
  setGeneralSettings(data: unknown, ttl?: number): void {
    this.set('general-settings', data, ttl);

  }

  getGeneralSettings(): Record<string, any> | null {
   ...
   */
  setAuthSettings(data: unknown, ttl?: number): void {
    this.set('auth-settings', data, ttl);

  }

  getAuthSettings(): Record<string, any> | null {
   ...
   */
  setUserSettings(data: unknown, ttl?: number): void {
   ...
   */
  setDatabaseSettings(data: unknown, ttl?: number): void {
    this.set('database-settings', data, ttl);

  }

  getDatabaseSettings(): Record<string, any> | null {
   ...
   */
  setEmailSettings(data: unknown, ttl?: number): void {
    this.set('email-settings', data, ttl);

  }

  getEmailSettings(): Record<string, any> | null {
   ...
   */
  setIntegrationSettings(data: unknown, ttl?: number): void {
    this.set('integration-settings', data, ttl);

  }

  getIntegrationSettings(): Record<string, any> | null {
   ...
   */
  setAISettings(data: unknown, ttl?: number): void {
    this.set('ai-settings', data, ttl);

  }

  getAISettings(): Record<string, any> | null {
   ...
   */
  setAPISettings(data: unknown, ttl?: number): void {
    this.set('api-settings', data, ttl);

  }

  getAPISettings(): Record<string, any> | null {
