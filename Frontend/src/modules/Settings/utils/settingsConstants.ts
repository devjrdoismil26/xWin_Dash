...
export const SETTINGS_CATEGORIES: unknown = {
  GENERAL: 'general',
  AUTH: 'auth',
  USERS: 'users',
  DATABASE: 'database',
...
export const SETTINGS_CATEGORY_LABELS: unknown = {
...
export const SETTINGS_CATEGORY_ICONS: unknown = {
...
export const SETTINGS_CATEGORY_COLORS: unknown = {
...
export const SETTINGS_TYPES: unknown = {
  STRING: 'string',
  NUMBER: 'number',
  BOOLEAN: 'boolean',
  JSON: 'json',
...
export const SETTINGS_TYPE_LABELS: unknown = {
...
export const SETTINGS_TYPE_COLORS: unknown = {
...
export const DEFAULT_GENERAL_SETTINGS: unknown = {
  app_name: 'xWin Dash',
  app_version: '1.0.0',
...
export const DEFAULT_AUTH_SETTINGS: unknown = {
...
export const SUPPORTED_TIMEZONES: unknown = {
...
export const SUPPORTED_CURRENCIES: unknown = {
...
export const DATE_FORMATS: unknown = {
...
export const TIME_FORMATS: unknown = {
  '12h': '12 horas (AM/PM)',
  '24h': '24 horas'
} as const;
...
export const SUPPORTED_THEMES: unknown = {
  'light': 'Claro',
  'dark': 'Escuro',
  'auto': 'Automático'
} as const;
...
export const LOG_LEVELS: unknown = {
  'error': 'Erro',
  'warn': 'Aviso',
  'info': 'Informação',
  'debug': 'Debug'
...
export const TWO_FACTOR_METHODS: unknown = {
  'email': 'Email',
  'sms': 'SMS',
  'app': 'Aplicativo',
...
export const OAUTH_PROVIDERS: unknown = {
  'google': 'Google',
  'facebook': 'Facebook',
  'twitter': 'Twitter',
  'github': 'GitHub',
...
export const ALLOWED_FILE_TYPES: unknown = {
...
export const VALIDATION_LIMITS: unknown = {
  password: {
    min_length: 6,
    max_length: 128,
    min_uppercase: 0,
...
export const PERFORMANCE_CONFIG: unknown = {
  debounce_delay: 300,
