...
import UniversalConnectors from '../components/Integration/UniversalConnectors';
import EnterpriseArchitecture from '../components/Enterprise/EnterpriseArchitecture';
import ARVRInterface from '../components/Immersive/ARVRInterface';
  ...
  const renderOverview = () => {
    ...
    return (
      <motion.div
        ...
        transition={ENHANCED_TRANSITIONS.standard}
        className="space-y-6"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {overviewCards.map((card, index) => (
            <motion.div
              ...
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ ...ENHANCED_TRANSITIONS.standard, delay: index * 0.1 }}
            >
