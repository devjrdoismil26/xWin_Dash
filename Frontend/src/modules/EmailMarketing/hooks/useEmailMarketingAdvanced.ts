...
import { EmailAutomationFlow, EmailAutomationTriggerAdvanced, EmailAutomationConditionAdvanced, EmailAutomationAction, EmailAutomationLog, EmailAutomationPerformance, EmailDeliverability, EmailDeliverabilityTest, EmailCompliance, EmailComplianceCheck, EmailABTest, EmailPersonalization, EmailOptimization, UseEmailAutomationFlowsReturn, UseEmailAutomationTriggersReturn, UseEmailAutomationConditionsReturn, UseEmailAutomationActionsReturn, UseEmailAutomationLogsReturn, UseEmailAutomationPerformanceReturn, UseEmailDeliverabilityReturn, UseEmailComplianceReturn, UseEmailABTestingReturn, UseEmailPersonalizationReturn, UseEmailOptimizationReturn } from '../types/emailTypes';
...
export const useEmailAutomationFlows = (): UseEmailAutomationFlowsReturn => {
  ...
  const getFlow = useCallback(async (id: string) => {
    ...
    try {
      ...
      if (response.success) {
        return (response as any).data as EmailAutomationFlow;
      } else {
...
export const useEmailAutomationTriggers = (): UseEmailAutomationTriggersReturn => {
  ...
  const createTrigger = useCallback(async (data: unknown) => {
    setLoading(true);
    ...
    try {
      ...
      if (response.success) {
        ...
        return (response as any).data as EmailAutomationTriggerAdvanced;
      } else {
  ...
  const updateTrigger = useCallback(async (id: string, data: unknown) => {
    setLoading(true);
...
export const useEmailAutomationConditions = (): UseEmailAutomationConditionsReturn => {
  ...
  const createCondition = useCallback(async (data: unknown) => {
    setLoading(true);
    ...
    try {
      ...
      if (response.success) {
        ...
        return (response as any).data as EmailAutomationConditionAdvanced;
      } else {
  ...
  const updateCondition = useCallback(async (id: string, data: unknown) => {
    setLoading(true);
...
export const useEmailAutomationActions = (): UseEmailAutomationActionsReturn => {
  ...
  const createAction = useCallback(async (data: unknown) => {
    setLoading(true);
    ...
    try {
      ...
      if (response.success) {
        ...
        return (response as any).data as EmailAutomationAction;
      } else {
  ...
  const updateAction = useCallback(async (id: string, data: unknown) => {
    setLoading(true);
...
export const useEmailDeliverability = (): UseEmailDeliverabilityReturn => {
  ...
  const testDeliverability = useCallback(async (testData: unknown) => {
    setLoading(true);
    ...
    try {
      ...
      if (response.success) {
        return (response as any).data as EmailDeliverabilityTest;
      } else {
...
export const useEmailCompliance = (): UseEmailComplianceReturn => {
  ...
  const checkCompliance = useCallback(async (checkType: string) => {
    ...
    try {
      ...
      if (response.success) {
        return (response as any).data as EmailComplianceCheck;
      } else {
...
export const useEmailABTesting = (): UseEmailABTestingReturn => {
  ...
  const createTest = useCallback(async (data: unknown) => {
    setLoading(true);
    ...
    try {
      ...
      if (response.success) {
        ...
        return (response as any).data as EmailABTest;
      } else {
  ...
  const updateTest = useCallback(async (id: string, data: unknown) => {
    setLoading(true);
...
export const useEmailPersonalization = (): UseEmailPersonalizationReturn => {
  ...
  const createPersonalization = useCallback(async (data: unknown) => {
    setLoading(true);
    ...
    try {
      ...
      if (response.success) {
        ...
        return (response as any).data as EmailPersonalization;
      } else {
  ...
  const updatePersonalization = useCallback(async (id: string, data: unknown) => {
    setLoading(true);
...
export { useEmailMarketingAdvanced };
