...
export const useEmailCampaigns = (): UseEmailCampaignsReturn => {
  ...
  const createCampaign = useCallback(async (data: Partial<EmailCampaign>) => {
    ...
    try {
      ...
      const errorMessage = getErrorMessage(err) || 'Erro ao criar campanha';
      setError(errorMessage);
  ...
  const updateCampaign = useCallback(async (id: string, data: Partial<EmailCampaign>) => {
    ...
    try {
      ...
      const errorMessage = getErrorMessage(err) || 'Erro ao atualizar campanha';
      setError(errorMessage);
  ...
  const deleteCampaign = useCallback(async (id: string) => {
    ...
    try {
      ...
      const errorMessage = getErrorMessage(err) || 'Erro ao excluir campanha';
      setError(errorMessage);
