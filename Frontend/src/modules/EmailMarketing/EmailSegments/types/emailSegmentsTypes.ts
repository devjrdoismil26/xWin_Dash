...
export interface UseEmailSegmentsReturn {
  ...
  formatSegmentMetrics: (metrics: SegmentMetrics) => Record<string, any>;
  validateSegment: (segment: EmailSegment) => { isValid: boolean;
  errors: string[] 
  data?: string;
  success?: boolean;
  message?: string; };
...
export interface UseSegmentBuilderReturn {
  ...
  addCriteria?: (e: any) => void;
  updateCriteria?: (e: any) => void;
  removeCriteria?: (e: any) => void;
  addGroup?: (e: any) => void;
  updateGroup?: (e: any) => void;
  removeGroup?: (e: any) => void;
  previewSegment: () => Promise<SegmentPreviewResponse>;
  validateSegment: () => { isValid: boolean;
