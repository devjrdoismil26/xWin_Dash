...
vi.mock("@/shared/components/ui/Select", () => ({
  Select: ({ children, value, onValueChange }: Record<string, any>) => (
    <select value={value} onChange={ (e: unknown) => onValueChange(e.target.value)  }>
      {children}
    </select>
  ),
}));
...
vi.mock("@/shared/components/ui/PageTransition", () => ({
...
describe("AIDashboard - Integration Tests", () => {
  ...
  describe("Renderização básica", () => {
    it("deve renderizar dashboard básico corretamente", () => {
      ...
      expect(
        screen.getByText("Gerencie suas ferramentas de IA"),
      ).toBeInTheDocument();
    ...
    it("deve renderizar dashboard avançado corretamente", () => {
      ...
      expect(
        screen.getByText("Dashboard avançado com métricas detalhadas"),
      ).toBeInTheDocument();
    ...
    it("deve renderizar dashboard revolucionário corretamente", () => {
      ...
      expect(
        screen.getByText("Interface revolucionária com IA preditiva"),
      ).toBeInTheDocument();
  ...
  describe("Status dos providers", () => {
    ...
    it("não deve exibir status dos providers para variante básica", () => {
      ...
      expect(
        screen.queryByText("Status dos Providers"),
  ...
  describe("Features grid", () => {
    ...
    it("deve exibir features avançadas para variante advanced", () => {
      ...
      expect(
        screen.getByText("Gerenciamento de Providers"),
      ).toBeInTheDocument();
  ...
  describe("Interação com features", () => { it("deve permitir navegação para features", () => {
      ...
      expect(onActionMock).toHaveBeenCalledWith("navigate", {
        href: "/ai/generation",
      });
