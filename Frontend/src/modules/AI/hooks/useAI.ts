...
import { AIProvider, AIGenerationType, AIGeneration, AIChatMessage, AIAnalytics, AIFilters } from '../types';
...
interface UseAIReturn {
  ...
  analyticsData: AIAnalytics | null;
  // Ações principais
...
/**
 * Hook useAI - Hook Orquestrador do Módulo AI
 * @function
 * @description
 * Hook orquestrador que coordena todos os hooks especializados do módulo AI,
 * fornecendo interface unificada para operações de geração, provedores, histórico e analytics.
 *
 * @returns {UseAIReturn} Objeto com estado consolidado, dados e ações
 *
 * @example
 * ```typescript
 * const {
