/**
 * Constantes do módulo AI
 *
 * @description
 * Constantes e configurações padrão para o módulo AI incluindo
 * limites de tokens, configurações de API, limites de requisições e timeouts.
 *
 * @module modules/AI/utils/aiConstants
 * @since 1.0.0
 */
...
/**
 * Configurações padrão do módulo AI
 *
 * @constant DEFAULT_CONFIG
 * @description
 * Configurações padrão para gerações AI incluindo limites e timeouts.
 */
 ...
 * Limites de API
 */
export const API_LIMITS: unknown = {
  OPENAI: {
    MAX_TOKENS: 8192,
 ...
 */
export const TOKEN_COSTS: unknown = {
  OPENAI: {
    'gpt-4': 0.00003,
 ...
 */
export const AVAILABLE_MODELS: unknown = {
  OPENAI: [
    'gpt-4',
    'gpt-4-turbo',
    'gpt-3.5-turbo',
 ...
 */
export const PROVIDER_CAPABILITIES: unknown = {
 ...
 */
export const IMAGE_SIZES: unknown = [
  '256x256',
  '512x512',
  '1024x1024'
];
 ...
 */
export const IMAGE_QUALITIES: unknown = [
  'standard',
  'hd'
];
 ...
 * Estilos de imagem
 */
export const IMAGE_STYLES: unknown = [
  'vivid',
  'natural'
];
 ...
 * Resoluções de vídeo
 */
export const VIDEO_RESOLUTIONS: unknown = [
  '720p',
  '1080p',
  '4k'
];
 ...
 */
export const VIDEO_DURATIONS: unknown = [
  5, 10, 15, 30, 60
];
 ...
 */
export const EXPORT_FORMATS: unknown = [
  'json',
  'csv',
  'xlsx'
];
 ...
 */
export const NOTIFICATION_TYPES: unknown = [
  'success',
  'error',
  'warning',
  'info'
 ...
 * Status de geração
 */
export const GENERATION_STATUS: unknown = [
  'pending',
  'processing',
  'completed',
  'failed',
 ...
 * Status de provedor
 */
export const PROVIDER_STATUS: unknown = [
  'active',
  'inactive',
  'error',
  'maintenance'
 ...
 * Idiomas suportados
 */
export const SUPPORTED_LANGUAGES: unknown = [
  'pt',
  'en',
  'es',
  'fr',
 ...
 */
export const DOCUMENTATION_URLS: unknown = {
 ...
 */
export const STATUS_URLS: unknown = {
 ...
 */
export const RETRY_CONFIG: unknown = {
  MAX_ATTEMPTS: 3,
  INITIAL_DELAY: 1000,
  MAX_DELAY: 10000,
  BACKOFF_FACTOR: 2};
 ...
 */
export const TIMEOUT_CONFIG: unknown = {
  DEFAULT: 30000,
