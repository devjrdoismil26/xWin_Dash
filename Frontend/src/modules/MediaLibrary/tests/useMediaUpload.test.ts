...
describe("useMediaUpload", () => {
  const mockMediaLibraryService =
    require("../services/mediaLibraryService").mediaLibraryService;
  ...
  describe("uploadFiles", () => {
    ...
    it("deve lidar com erro durante upload", async () => {
      ...
      mockMediaLibraryService.uploadMedia.mockRejectedValue(
    ...
    it("deve validar tipos de arquivo", async () => {
      ...
      expect(result.current.uploads[0].error).toContain(
