 ...
 * @module modules/Analytics/types/analyticsInterfaces
 * @description
 * Interfaces específicas para o módulo Analytics, incluindo configurações,
 * dashboards, dados de tempo real, integrações, exportações, agendamentos e muito mais.
 * @since 1.0.0
 */

/**
 * Interface AnalyticsConfig - Configurações de Analytics
 * @interface AnalyticsConfig
 * @description
 * Interface para configurações gerais do módulo Analytics, incluindo cache,
 * tempo real, processamento, exportação, integrações, segurança e monitoramento.
 * @property {boolean} enabled - Se o analytics está habilitado
 * @property {object} cache - Configurações de cache
 * @property {object} realtime - Configurações de tempo real
 * @property {object} processing - Configurações de processamento
 * @property {object} export - Configurações de exportação
 * @property {object} integrations - Configurações de integrações
 * @property {object} security - Configurações de segurança
 * @property {object} monitoring - Configurações de monitoramento
 */
