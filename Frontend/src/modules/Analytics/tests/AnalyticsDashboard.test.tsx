...
describe("AnalyticsDashboard Component", () => {
      ...
      insights: [
        {
          ...
          description: "Page views increased by 12.5%",
        },
      ],
    },
    loading: false,
  ...
  it("should toggle auto-refresh", async () => {
    ...
    const autoRefreshToggle = screen.getByRole("button", {
      name: /auto refresh/i,
    });
  ...
  it("should display real-time status when enabled", () => {
    ...
    expect(
      screen.getByText(/monitoramento em tempo real ativo/i),
    ).toBeInTheDocument();
  ...
  it("should display auto-refresh status when enabled", () => {
    ...
    expect(
      screen.getByText(/atualização automática ativa/i),
    ).toBeInTheDocument();
