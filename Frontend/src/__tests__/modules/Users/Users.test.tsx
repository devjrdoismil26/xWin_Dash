...
const Users = () => {
  ...
  const updateUser = (id: string, updates: unknown) => {
    setUsers(
  ...
  return (
      ...
      </div><h1>Users Management</h1>

      {/* Estatísticas */}
      <div data-testid="stats">
           
        </div><div>Total de usuários: {stats.total}</div>
      ...
      <div data-testid="filters">
        ...
        >
          ...
          <option value="user">Usuário</option></select><select
        ...
        >
          ...
          <option value="inactive">Inativo</option></select></div>
      ...
      {showUserForm && (
        <div data-testid="user-form" className="user-form">
          ...
          <select data-testid="form-role" />
            ...
            <option value="moderator">Moderador</option>
            <option value="admin">Administrador</option></select><button data-testid="form-submit">Salvar</button>
      </div>
    </>
  )}
  ...
  >
              ...
              <button
                onClick={() = />
                  updateUser(user.id, { name: `${user.name} (Editado)` })
  }
