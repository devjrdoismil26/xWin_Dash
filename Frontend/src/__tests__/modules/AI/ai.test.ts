...
import { aiService, aiProviderService, aiGenerationService, aiAnalyticsService,  } from '../services';
import { formatCurrency, formatNumber, formatPercentage, calculateCTR, calculateCPC, calculateROI,  } from '../utils';
...
describe("AI Module", () => {
  ...
  describe("useAIGeneration Hook", () => {
    ...
    it("should generate text successfully", async () => {
      ...
      (aiGenerationService.generateText as jest.Mock).mockResolvedValue(
        mockResponse,);
    ...
    it("should handle generation errors", async () => {
      ...
      (aiGenerationService.generateText as jest.Mock).mockRejectedValue(
        mockError,);
  ...
  describe("useAIAnalytics Hook", () => {
    ...
    it("should load analytics successfully", async () => {
      ...
      expect(result.current.totalCost).toBe(50.0);
