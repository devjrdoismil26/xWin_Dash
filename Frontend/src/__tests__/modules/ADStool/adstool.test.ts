...
import { adsAccountService, adsCampaignService, adsCreativeService, adsAnalyticsService, adsTemplateService,  } from '../services';
  ...
  describe("Services", () => {
    describe("adsAccountService", () => {
      ...
      it("should create account", async () => {
        ...
        (adsAccountService.createAccount as jest.Mock).mockResolvedValue(
          mockResponse,);
    ...
    describe("adsCampaignService", () => {
      ...
      it("should create campaign", async () => {
        ...
        (adsCampaignService.createCampaign as jest.Mock).mockResolvedValue(
          mockResponse,);
