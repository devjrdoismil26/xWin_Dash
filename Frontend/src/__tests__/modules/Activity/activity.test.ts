...
describe("Activity Module Tests", () => {
  ...
  describe("ActivityValidationService", () => {
    ...
    it("should sanitize search queries", () => {
      ...
      const sanitized =
        activityValidationService.sanitizeSearchQuery(dangerousQuery);
  ...
  describe("useActivity Hook", () => {
    ...
    it("should handle select all and clear selection", () => {
      ...
      jest
        .spyOn(useActivityStore.getState(), "logs", "get")
        .mockReturnValue(mockLogs);
  ...
  describe("Performance Tests", () => {
    it("should handle large datasets efficiently", () => {
      const largeDataset: ActivityLog[] = Array.from(
        { length: 1000 },
        (_, i) => ({
          id: i.toString(),
          log_name: "test",
