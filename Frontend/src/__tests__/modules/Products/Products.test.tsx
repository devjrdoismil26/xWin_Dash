...
const Products = () => {
  ...
  const createProduct = (productData: unknown) => {
    const newProduct = {
  ...
  const updateProduct = (id: string, updates: unknown) => {
    setProducts(
  ...
  return (
      ...
      </div><h1>Products Management</h1>

      {/* Estatísticas */}
      <div data-testid="stats">
           
        </div><div>Total de produtos: {stats.total}</div>
      ...
      <div data-testid="filters">
        ...
        >
          ...
          <option value="clothing">Roupas</option></select></div>
