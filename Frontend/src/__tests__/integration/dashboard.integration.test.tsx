...
import { ExecutiveMasterDashboard } from '../shared/components/ExecutiveMasterDashboard';
import { MetricsOverview } from '../shared/components/MetricsOverview';
import { AdvancedDashboard } from '../shared/components/AdvancedDashboard';
import { WidgetManager } from '../shared/components/WidgetManager';
...
describe("Dashboard Integration Tests", () => {
  ...
  describe("ExecutiveMasterDashboard Component", () => {
    it("should render executive dashboard correctly", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Executive Master Dashboard"),
        ).toBeInTheDocument();
  ...
  describe("MetricsOverview Component", () => {
    it("should render metrics overview correctly", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Visão Geral das Métricas"),
        ).toBeInTheDocument();
  ...
  describe("Error Handling Integration", () => {
    it("should handle service errors gracefully", async () => {
      ...
      dashboardService.getDashboardData.mockRejectedValueOnce(
