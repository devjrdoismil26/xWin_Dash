...
import { ActivityDashboard } from '../shared/components/ActivityDashboard';
import { ActivityStats } from '../shared/components/ActivityStats';
import { ActivityFilters } from '../shared/components/ActivityFilters';
...
describe("Activity Integration Tests", () => {
  beforeEach(() => {
    mockUseActivity.mockReturnValue({
      ...
      getErrorLogs: jest.fn(() =>
        (mockLogs || []).filter((log) => log.log_name.includes("error")),
      ),
  ...
  describe("ActivityFilters", () => {
    it("should render filter controls", () => {
      render(
        <ActivityFilters
          filters={} onFiltersChange={ jest.fn() }
          onClearFilters={ jest.fn() } />,);

      expect(
        screen.getByPlaceholderText("Buscar atividades..."),
      ).toBeInTheDocument();
    ...
    it("should handle search input", async () => {
      ...
      render(
        <ActivityFilters
          filters={} onFiltersChange={ mockOnFiltersChange }
          onClearFilters={ jest.fn() } />,);
