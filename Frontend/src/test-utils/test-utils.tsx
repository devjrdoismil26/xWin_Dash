...
import { AdvancedThemeProvider } from '@/shared/components/ui/AdvancedThemeProvider';
  ...
  return (
      ...
      <ThemeProvider defaultTheme={ theme } />
        <AdvancedThemeProvider />
          {content}
        </AdvancedThemeProvider></ThemeProvider></QueryClientProvider>);};

// Função de render customizada
const customRender = (ui: ReactElement,
  options: CustomRenderOptions = {} as any
) => {
  const {
    queryClient,
    theme,
...
export const testUtils = {
  ...
  // Helpers para testes
  waitFor: async (callback??: (e: any) => void, options = {} as any) => {
