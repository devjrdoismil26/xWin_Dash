...
class CampaignPausedNotificationMail extends Mailable
{
    use Queueable;
    ...
    {
        return $this->subject('Sua Campanha de E-mail Foi Pausada')
                    ->markdown('emails.email-marketing.campaign-paused') // Supondo um template Blade
                    ->with([
