...
class CampaignCompletedNotificationMail extends Mailable
{
    use Queueable;
    ...
    {
        return $this->subject('Sua Campanha de E-mail Foi Concluída!')
                    ->markdown('emails.email-marketing.campaign-completed') // Supondo um template Blade
                    ->with([
