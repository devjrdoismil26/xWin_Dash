...
/**
 * Evento disparado quando um campo personalizado de Lead é deletado.
 */
class LeadCustomFieldDeleted
{
    use Dispatchable;
    ...
    /**
     * @var LeadCustomField o campo personalizado de Lead que foi deletado
     */
