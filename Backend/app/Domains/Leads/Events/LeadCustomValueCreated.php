...
/**
 * Evento disparado quando um novo valor personalizado de Lead é criado.
 */
class LeadCustomValueCreated
{
    use Dispatchable;
    ...
    /**
     * @var LeadCustomValue o valor personalizado de Lead que foi criado
     */
