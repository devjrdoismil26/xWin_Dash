...
/**
 * Evento disparado quando um valor personalizado de Lead é deletado.
 */
class LeadCustomValueDeleted
{
    use Dispatchable;
    ...
    /**
     * @var LeadCustomValue o valor personalizado de Lead que foi deletado
     */
