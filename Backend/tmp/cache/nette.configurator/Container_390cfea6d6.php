...
// source: phar:///root/projetos/xWin_Dash/Backend/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon
...
class Container_390cfea6d6 extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.phpDoc.typeNodeResolverExtension' => ['0543' => true, '0544' => true, '0550' => true, '0554' => true],
		'phpstan.collector' => ['0568' => true, '0569' => true, '0570' => true, '0571' => true, '0572' => true],
	];
	...
	protected $wiring = [
		...
		'PHPStan\PhpDoc\TypeNodeResolverExtension' => [['0543', '0544', '0550', '0554']],
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_390cfea6d6 $container)
			{
	...
	public function createService066(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'phar:///root/projetos/xWin_Dash/Backend/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'phar:///root/projetos/xWin_Dash/Backend/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon',
				'phar:///root/projetos/xWin_Dash/Backend/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchCheck($this->getService('0169'), true, false, false, false);
	}
	...
	{
		return new PHPStan\Rules\RuleLevelHelper($this->getService('reflectionProvider'), true, false, true, false, false, false, false);
	}
	...
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('0140'), $this->getService('0169'), true);
	}
	...
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule($this->getService('0169'), true);
	}
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule($this->getService('0169'), $this->getService('0123'), true);
	}
	...
	{
		return new PHPStan\Rules\Generators\YieldFromTypeRule($this->getService('0169'), true);
	}
	...
	{
		return new Larastan\Larastan\Methods\BuilderHelper($this->getService('reflectionProvider'), false, $this->getService('0494'));
	}
	...
	public function createServiceContainer(): Container_390cfea6d6
	{
		return $this;
	}
