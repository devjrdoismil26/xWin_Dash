...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may define settings related to two-factor authentication.
    |
    */

    'two_factor' => [
        'enabled' => env('TWO_FACTOR_ENABLED', false),
        'provider' => env('TWO_FACTOR_PROVIDER', 'email'), // email, sms, authenticator
        'expire' => env('TWO_FACTOR_EXPIRE', 5), // minutes
        'throttle' => env('TWO_FACTOR_THROTTLE', 3), // attempts
    ],
    ...
    */
    ...
    'security' => [
        ...
        'password_history' => env('PASSWORD_HISTORY_COUNT', 3), // number of previous passwords to check
