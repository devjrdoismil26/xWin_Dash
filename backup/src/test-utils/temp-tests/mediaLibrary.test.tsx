...
import { MediaLibraryDashboard } from '../components/MediaLibraryDashboard';
import { MediaLibraryHeader } from '../components/MediaLibraryHeader';
import { MediaLibraryStats } from '../components/MediaLibraryStats';
...
describe('MediaLibrary Components', () => {
  ...
  describe('MediaLibraryStats', () => {
    ...
    it('deve exibir erro quando houver', () => {
      ...
      expect(screen.getByText('Erro ao carregar estatísticas: Erro ao carregar estatísticas')).toBeInTheDocument();
    });
  });
