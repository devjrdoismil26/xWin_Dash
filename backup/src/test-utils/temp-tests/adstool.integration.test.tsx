...
describe('ADStool Integration Tests', () => {
  ...
  describe('ADStoolIndex Component', () => {
    ...
    it('should switch to advanced dashboard when button is clicked', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Voltar ao Dashboard Básico')).toBeInTheDocument();
      });
    });
  ...
  describe('ADStoolCreatePage Component', () => {
    ...
    it('should handle form submission', async () => {
      ...
      const nameInput = screen.getByPlaceholderText('Digite o nome do campaign');
      const platformSelect = screen.getByDisplayValue('Selecione uma plataforma');
