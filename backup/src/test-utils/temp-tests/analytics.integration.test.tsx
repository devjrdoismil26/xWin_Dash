...
describe('Analytics Integration Tests', () => {
  ...
  describe('Analytics Error Handling', () => {
    it('should handle loading errors', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Erro ao carregar analytics')).toBeInTheDocument();
      });
    });
    ...
    it('should handle network errors', async () => {
      ...
      await waitFor(() => {
        expect(mockUseAnalytics().dashboard.loadDashboardData).toHaveBeenCalled();
      });
    });
  });
