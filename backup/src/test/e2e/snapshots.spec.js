...
test.describe('Visual Snapshots', () => {
  ...
  test('should match navigation snapshot', async ({ page }) => {
    ...
    const navigation = page.locator('nav, [data-testid="navigation"], .navigation').first();
  ...
  test('should match dark mode snapshot', async ({ page }) => {
    ...
    const darkModeToggle = page.locator('[data-testid="dark-mode-toggle"], .dark-mode-toggle').first();
  ...
  test('should match component snapshots', async ({ page }) => {
    ...
    const cards = page.locator('[data-testid="metric-card"], .card, .metric-card');
