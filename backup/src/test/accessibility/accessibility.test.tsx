...
describe('Accessibility Tests', () => {
  describe('IntelligentDashboard', () => {
    ...
    it('should have proper color contrast', () => {
      ...
      const textElements = container.querySelectorAll('p, span, div[role="text"]');
      textElements.forEach(element => {
        const classes = element.className;
        // Should have proper text color classes
        expect(classes).toMatch(/text-(gray|white|black|blue|green|red|yellow)/);
      });
    });
  ...
  describe('General Accessibility Guidelines', () => {
    ...
    it('should have proper alt text for images', () => {
      const { container } = render(
        <div>
          <img src="chart.png" alt="Revenue trend chart showing growth over time" />
