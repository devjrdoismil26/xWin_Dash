...
describe('Email Marketing Service Tests', () => {
  ...
  describe('Utility Functions', () => {
    ...
    it('should calculate statistics correctly', () => {
      const calculateStats = (campaigns: any[]) => {
        ...
        const avgOpenRate = campaigns.reduce((sum, c) => sum + c.openRate, 0) / total;
        const avgClickRate = campaigns.reduce((sum, c) => sum + c.clickRate, 0) / total;
  ...
  describe('Data Transformation', () => {
    it('should transform campaign data for display', () => {
      const transformCampaign = (campaign: any) => {
        return {
          ...
          displayStatus: campaign.status.charAt(0).toUpperCase() + campaign.status.slice(1),
    ...
    it('should sort campaigns by date', () => {
      const sortCampaigns = (campaigns: any[], order: 'asc' | 'desc' = 'desc') => {
