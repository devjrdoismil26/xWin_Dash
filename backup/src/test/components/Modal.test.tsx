...
describe('Modal', () => {
  ...
  it('renders with different sizes', () => {
    ...
    expect(lgContainer.querySelector('[data-testid="modal-content"]')).toHaveClass('max-w-4xl');
  });
  ...
  it('renders with custom className', () => {
    ...
    expect(container.querySelector('[data-testid="modal-content"]')).toHaveClass('custom-modal');
  });
