...
interface UniverseToolbarProps {
  onAddNode: (nodeType: BlockType) => void;
  onToggle: () => void;
  className?: string;
}
...
const UniverseToolbar: React.FC<UniverseToolbarProps> = ({ 
  onAddNode, 
  onToggle, 
  className 
}) => {
      ...
      <div className="p-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <p className="text-xs text-gray-500">Drag blocks to canvas or click to add</p>
          </div>
          <Button
            size="sm"
            variant="ghost"
      ...
      <div className="p-4 border-t border-gray-200 bg-gray-50">
        <div className="text-xs text-gray-500 space-y-1">
          <div className="flex items-center gap-1">
            <span>💡</span>
            <span>Drag blocks to canvas or click to add</span>
          </div>
          <div className="flex items-center gap-1">
            <span>🔗</span>
            <span>Connect blocks by dragging between handles</span>
          </div>
          <div className="flex items-center gap-1">
            <span>⚡</span>
            <span>Use AI Chat for smart suggestions</span>
          </div>
        </div>
      </div>
    </div>
