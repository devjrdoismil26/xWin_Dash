...
const LeadMetricsDisplay: React.FC<LeadMetricsDisplayProps> = ({ 
  metrics, 
  period = '30d', 
  loading, 
  error 
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-900">Métricas de Leads</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-medium text-green-800">Leads Ganhos</span>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-medium text-red-800">Leads Perdidos</span>
                </div>
