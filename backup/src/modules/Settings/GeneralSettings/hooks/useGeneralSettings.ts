...
export interface UseGeneralSettingsActions {
  ...
  // Filters and Search
  setFilters: (filters: GeneralSettingsFilters) => void;
  clearFilters: () => void;
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        setState(prev => ({
          ...prev,
          loading: false,
          error: response.error || 'Erro ao carregar configurações'
        }));
      }
    } catch (error: any) {
      setState(prev => ({
        ...prev,
        loading: false,
        error: error.message || 'Erro inesperado ao carregar configurações'
      }));
    }
  }, [state.filters]);
  ...
  const loadSettingById = useCallback(async (id: string) => {
    ...
    try {
      ...
      if (response.success && response.data) {
        setState(prev => ({
          ...prev,
          currentSetting: response.data as GeneralSettings,
          loading: false
        }));
      } else {
        setState(prev => ({
          ...prev,
          loading: false,
          error: response.error || 'Erro ao carregar configuração'
        }));
      }
    } catch (error: any) {
      setState(prev => ({
        ...prev,
        loading: false,
        error: error.message || 'Erro inesperado ao carregar configuração'
      }));
    }
  }, []);
    ...
    try {
      ...
      if (response.success) {
        ...
        setState(prev => ({
          ...prev,
          loading: false,
          error: response.error || 'Erro ao criar configuração'
        }));
        return false;
      }
    } catch (error: any) {
      setState(prev => ({
        ...prev,
        loading: false,
        error: error.message || 'Erro inesperado ao criar configuração'
      }));
      return false;
    }
  }, [loadSettings]);
    ...
    try {
      ...
      if (response.success) {
        ...
        setState(prev => ({
          ...prev,
          loading: false,
          error: response.error || 'Erro ao atualizar configuração'
        }));
        return false;
      }
    } catch (error: any) {
      setState(prev => ({
        ...prev,
        loading: false,
        error: error.message || 'Erro inesperado ao atualizar configuração'
      }));
      return false;
    }
  }, [loadSettings]);
    ...
    try {
      ...
      if (response.success) {
        ...
        setState(prev => ({
          ...prev,
          loading: false,
          error: response.error || 'Erro ao deletar configuração'
        }));
        return false;
      }
    } catch (error: any) {
      setState(prev => ({
        ...prev,
        loading: false,
        error: error.message || 'Erro inesperado ao deletar configuração'
      }));
      return false;
    }
  }, [loadSettings]);
    ...
    try {
      ...
      if (response.success) {
        ...
        setState(prev => ({
          ...prev,
          loading: false,
          error: response.error || 'Erro ao atualizar configurações'
        }));
        return false;
      }
    } catch (error: any) {
      setState(prev => ({
        ...prev,
        loading: false,
        error: error.message || 'Erro inesperado ao atualizar configurações'
      }));
      return false;
    }
  }, [loadSettings]);
    ...
    try {
      ...
      if (response.success) {
        ...
        setState(prev => ({
          ...prev,
          loading: false,
          error: response.error || 'Erro ao resetar configurações'
        }));
        return false;
      }
    } catch (error: any) {
      setState(prev => ({
        ...prev,
        loading: false,
        error: error.message || 'Erro inesperado ao resetar configurações'
      }));
      return false;
    }
  }, [loadSettings]);
