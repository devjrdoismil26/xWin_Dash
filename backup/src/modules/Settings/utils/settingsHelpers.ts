 ...
 */
export function validateSettingValue(value: any, type: string, rules?: any[]): {
  isValid: boolean;
  errors: string[];
} {
  const errors: string[] = [];
 ...
 */
export function stringifySettingValue(value: any, type: string): string {
  switch (type) {
    case 'boolean':
 ...
 */
export function groupSettingsByCategory(settings: any[]): Record<string, any[]> {
 ...
 */
export function groupSettingsByType(settings: any[]): Record<string, any[]> {
  return settings.reduce((groups, setting) => {
 ...
 */
export function filterSettings(settings: any[], filters: {
  category?: string;
  type?: string;
  isRequired?: boolean;
  isPublic?: boolean;
 ...
 */
export function sortSettings(settings: any[], sortBy: string, sortOrder: 'asc' | 'desc' = 'asc'): any[] {
 ...
 */
export function calculateSettingsStats(settings: any[]): {
  total: number;
