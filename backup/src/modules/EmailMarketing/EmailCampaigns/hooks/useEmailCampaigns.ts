...
export const useEmailCampaigns = (): UseEmailCampaignsReturn => {
  ...
  const fetchCampaigns = useCallback(async (filters?: CampaignFilters) => {
    ...
    try {
      ...
      const response = await fetch(`/api/v1/email-campaigns?${queryParams}`, {
        method: 'GET',
        headers: {
  ...
  const sendCampaign = useCallback(async (id: string): Promise<CampaignResponse> => {
    try {
      const response = await fetch(`/api/v1/email-campaigns/${id}/send`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const pauseCampaign = useCallback(async (id: string): Promise<CampaignResponse> => {
    try {
      const response = await fetch(`/api/v1/email-campaigns/${id}/pause`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const resumeCampaign = useCallback(async (id: string): Promise<CampaignResponse> => {
    try {
      const response = await fetch(`/api/v1/email-campaigns/${id}/resume`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const getCampaignAnalytics = useCallback(async (id: string): Promise<CampaignAnalytics> => {
    try {
      const response = await fetch(`/api/v1/email-campaigns/${id}/analytics`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  const formatCampaignMetrics = useCallback((metrics: any) => {
    return {
  ...
  const calculateCampaignROI = useCallback((metrics: any): number => {
