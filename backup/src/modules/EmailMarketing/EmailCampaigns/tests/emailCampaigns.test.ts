...
describe('EmailCampaigns Module', () => {
  ...
  describe('useEmailCampaigns Hook', () => {
    ...
    it('should fetch campaigns successfully', async () => {
      ...
      (EmailCampaignsService.prototype.getCampaigns as jest.Mock).mockResolvedValue({
        success: true,
        data: mockCampaigns
      });
    ...
    it('should handle fetch campaigns error', async () => {
      ...
      (EmailCampaignsService.prototype.getCampaigns as jest.Mock).mockRejectedValue(mockError);
    ...
    it('should create campaign successfully', async () => {
      ...
      (EmailCampaignsService.prototype.createCampaign as jest.Mock).mockResolvedValue({
        success: true,
        data: mockCampaign
      });
      (EmailCampaignsService.prototype.getCampaigns as jest.Mock).mockResolvedValue({
    ...
    it('should update campaign successfully', async () => {
      ...
      (EmailCampaignsService.prototype.updateCampaign as jest.Mock).mockResolvedValue({
        success: true,
        data: mockCampaign
      });
      (EmailCampaignsService.prototype.getCampaigns as jest.Mock).mockResolvedValue({
    ...
    it('should delete campaign successfully', async () => {
      (EmailCampaignsService.prototype.deleteCampaign as jest.Mock).mockResolvedValue({
        success: true
      });
      (EmailCampaignsService.prototype.getCampaigns as jest.Mock).mockResolvedValue({
        success: true,
    ...
    it('should send campaign successfully', async () => {
      ...
      (EmailCampaignsService.prototype.sendCampaign as jest.Mock).mockResolvedValue(mockResponse);
    ...
    it('should pause campaign successfully', async () => {
      ...
      (EmailCampaignsService.prototype.pauseCampaign as jest.Mock).mockResolvedValue(mockResponse);
    ...
    it('should resume campaign successfully', async () => {
      ...
      (EmailCampaignsService.prototype.resumeCampaign as jest.Mock).mockResolvedValue(mockResponse);
    ...
    it('should get campaign analytics successfully', async () => {
      ...
      (EmailCampaignsService.prototype.getCampaignAnalytics as jest.Mock).mockResolvedValue({
        success: true,
        data: mockAnalytics
      });
