...
describe('EmailMarketingCore Module', () => {
  ...
  describe('useEmailMarketingCore Hook', () => {
    ...
    it('should fetch metrics successfully', async () => {
      ...
      (EmailMarketingCoreService.prototype.getMetrics as jest.Mock).mockResolvedValue({
        success: true,
        data: mockMetrics
      });
    ...
    it('should handle metrics fetch error', async () => {
      ...
      (EmailMarketingCoreService.prototype.getMetrics as jest.Mock).mockRejectedValue(mockError);
    ...
    it('should fetch stats successfully', async () => {
      ...
      (EmailMarketingCoreService.prototype.getStats as jest.Mock).mockResolvedValue({
        success: true,
        data: mockStats
      });
    ...
    it('should fetch dashboard data successfully', async () => {
      ...
      (EmailMarketingCoreService.prototype.getDashboard as jest.Mock).mockResolvedValue({
        success: true,
        data: mockDashboard
      });
