...
export interface EmailCampaignListProps {
  ...
  onCampaignSend?: (campaignId: number) => void;
}
...
export interface EmailListManagerProps {
  ...
  error?: string;
  onListCreate?: () => void;
  onListEdit?: (list: EmailList) => void;
...
export interface EmailSubscriberManagerProps {
  ...
  loading?: boolean;
  error?: string;
  onSubscriberAdd?: () => void;
  onSubscriberEdit?: (subscriber: EmailSubscriber) => void;
  onSubscriberDelete?: (subscriberId: number) => void;
  onSubscriberImport?: () => void;
}
...
export interface EmailSegmentManagerProps {
  ...
  onSegmentEdit?: (segment: EmailSegment) => void;
...
export interface EmailAutomationManagerProps {
  ...
  onAutomationEdit?: (automation: EmailAutomation) => void;
  onAutomationDelete?: (automationId: number) => void;
  onAutomationToggle?: (automationId: number) => void;
}
...
export interface EmailOptimizationProps {
  ...
  loading?: boolean;
  error?: string;
  onOptimize?: (campaignId: number) => void;
  onABTest?: (campaignId: number) => void;
}
...
export interface UseEmailAutomationTriggersReturn {
  ...
  createTrigger: (data: any) => Promise<EmailAutomationTriggerAdvanced | null>;
  updateTrigger: (id: string, data: any) => Promise<EmailAutomationTriggerAdvanced | null>;
...
export interface UseEmailAutomationConditionsReturn {
  ...
  createCondition: (data: any) => Promise<EmailAutomationConditionAdvanced | null>;
  updateCondition: (id: string, data: any) => Promise<EmailAutomationConditionAdvanced | null>;
...
export interface UseEmailAutomationActionsReturn {
  ...
  createAction: (data: any) => Promise<EmailAutomationAction | null>;
  updateAction: (id: string, data: any) => Promise<EmailAutomationAction | null>;
...
export interface UseEmailDeliverabilityReturn {
  ...
  testDeliverability: (testData: any) => Promise<EmailDeliverabilityTest | null>;
}
...
export interface UseEmailABTestingReturn {
  ...
  createTest: (data: any) => Promise<EmailABTest | null>;
  updateTest: (id: string, data: any) => Promise<EmailABTest | null>;
...
export interface UseEmailPersonalizationReturn {
  ...
  createPersonalization: (data: any) => Promise<EmailPersonalization | null>;
  updatePersonalization: (id: string, data: any) => Promise<EmailPersonalization | null>;
