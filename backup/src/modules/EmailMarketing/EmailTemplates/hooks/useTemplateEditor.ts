...
export const useTemplateEditor = (initialTemplate?: any): UseTemplateEditorReturn => {
  // Estado do editor
  ...
  const updateTemplate = useCallback((updates: any) => {
    setEditor(prev => ({
      ...prev,
      template: {
        ...prev.template,
  ...
  const saveTemplate = useCallback(async () => {
    try {
      ...
      console.log('Saving template:', editor.template);
