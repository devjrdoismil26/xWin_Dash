// ========================================
// COMPONENTE AÇÕES - ANALYTICS
// ========================================
// Componente para ações rápidas do módulo Analytics
...
export const AnalyticsActions: React.FC<AnalyticsActionsProps> = ({
  onRefresh,
  onExport,
  onShare,
  onSettings,
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">85% hit rate</div>
                </div>
              </div>
        ...
        <Card.Content>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-3 bg-orange-50 rounded-lg">
              ...
              <div className="text-sm text-orange-700">Duração</div>
            </div>
          </div>
        </Card.Content>
      </Card>
