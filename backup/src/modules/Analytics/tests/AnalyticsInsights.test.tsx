...
describe('AnalyticsInsights Component', () => {
  ...
  it('should render insights correctly', () => {
    render(<AnalyticsInsights {...defaultProps} />);
  ...
  it('should display correct insight type icons', () => {
    render(<AnalyticsInsights {...defaultProps} />);
  ...
  it('should display insight metrics', () => {
    render(<AnalyticsInsights {...defaultProps} />);
  ...
  it('should display no match message when filters result in empty list', () => {
    render(<AnalyticsInsights {...defaultProps} />);
