...
const GoogleAdsDashboard: React.FC<GoogleAdsDashboardProps> = ({ auth, metrics = {}, campaigns = [] }) => {
            ...
            <Card.Content className="p-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{(metrics.clicks || 0).toLocaleString('pt-BR')}</p>
                </div>
              </div>
            </Card.Content>
          </Card>
