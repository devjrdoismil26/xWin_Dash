      ...
      (set, get) => ({
        ...
        uploadCover: async (userId: string, data: CoverUploadData) => {
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao fazer upload da cover',
              uploadingCover: false
            });
            throw error;
          }
        ...
        removeCover: async (userId: string) => {
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao remover cover',
              updating: false
            });
            throw error;
          }
        ...
        fetchProfileStats: async (userId: string) => {
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao carregar estatísticas do perfil'
            });
          }
        },
        ...
        validateProfile: async (userId: string) => {
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao validar perfil',
              validating: false
            });
            throw error;
          }
        ...
        fetchPrivacySettings: async (userId: string) => {
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao carregar configurações de privacidade'
            });
          }
        },
        ...
        updatePrivacySettings: async (userId: string, settings: PrivacySettings) => {
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao atualizar configurações de privacidade',
              updating: false
            });
            throw error;
          }
        ...
        fetchPublicProfiles: async (params?: {
          ...
          try {
            ...
            set({
              publicProfiles: response.data,
              loading: false
            });
          } catch (error) {
            set({
              error: error instanceof Error ? error.message : 'Erro ao carregar perfis públicos',
              loading: false
            });
          }
        },
        ...
        unfollowUser: async (userId: string, targetUserId: string) => {
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao deixar de seguir usuário',
              updating: false
            });
            throw error;
          }
        ...
        isFollowing: async (userId: string, targetUserId: string) => {
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao verificar se está seguindo'
            });
            return false;
          }
        },
        ...
        fetchFollowers: async (userId: string, params?: { page?: number; limit?: number }) => {
          try {
            ...
            set({
              ...
              followersCount: response.total,
              loading: false
            });
          } catch (error) {
            set({
              error: error instanceof Error ? error.message : 'Erro ao carregar seguidores',
              loading: false
            });
          }
        },
        ...
        fetchFollowing: async (userId: string, params?: { page?: number; limit?: number }) => {
          try {
            ...
            set({
              ...
              followingCount: response.total,
              loading: false
            });
          } catch (error) {
            set({
              error: error instanceof Error ? error.message : 'Erro ao carregar usuários seguidos',
              loading: false
            });
          }
        },
