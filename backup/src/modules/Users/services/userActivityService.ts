...
class UserActivityService {
  ...
  async getActivityById(id: string): Promise<Activity> {
    try {
      ...
      // Cache do resultado
      activityCache.set(cacheKey, { data: response.data, timestamp: Date.now() });
  ...
  async getActivitiesByType(type: string, params: Omit<ActivitySearchParams, 'type'> = {}): Promise<ActivityPaginatedResponse> {
    try {
      ...
      console.error(`Erro ao buscar atividades do tipo ${type}:`, error);
  ...
  async getActivitiesByAction(action: string, params: Omit<ActivitySearchParams, 'action'> = {}): Promise<ActivityPaginatedResponse> {
    try {
      ...
      console.error(`Erro ao buscar atividades da ação ${action}:`, error);
  ...
  async getActivityTypes(): Promise<ActivityType[]> {
    try {
      ...
      console.error('Erro ao obter tipos de atividade:', error);
  ...
  async getActivitiesByLocation(location: string): Promise<Activity[]> {
    try {
      ...
      console.error(`Erro ao buscar atividades por localização ${location}:`, error);
  ...
  async getActivitiesByIP(ipAddress: string): Promise<Activity[]> {
    try {
      ...
      console.error(`Erro ao buscar atividades por IP ${ipAddress}:`, error);
  ...
  async getActivityTrends(params: {
    ...
    try {
      ...
      console.error('Erro ao obter tendências de atividade:', error);
