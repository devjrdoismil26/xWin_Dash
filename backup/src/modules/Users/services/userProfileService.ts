...
class UserProfileService {
  ...
  async getProfile(userId: string): Promise<UserProfile> {
    try {
      ...
      // Cache do resultado
      profileCache.set(cacheKey, { data: response.data, timestamp: Date.now() });
  ...
  async uploadAvatar(userId: string, data: AvatarUploadData): Promise<{ avatar_url: string }> {
    try {
      ...
      console.error(`Erro ao fazer upload do avatar do usuário ${userId}:`, error);
  ...
  async removeAvatar(userId: string): Promise<void> {
    try {
      ...
      console.error(`Erro ao remover avatar do usuário ${userId}:`, error);
  ...
  async uploadCover(userId: string, data: CoverUploadData): Promise<{ cover_url: string }> {
    try {
      ...
      console.error(`Erro ao fazer upload da cover do usuário ${userId}:`, error);
  ...
  async removeCover(userId: string): Promise<void> {
    try {
      ...
      console.error(`Erro ao remover cover do usuário ${userId}:`, error);
  ...
  async getProfileStats(userId: string): Promise<ProfileStats> {
    try {
      ...
      console.error(`Erro ao obter estatísticas do perfil ${userId}:`, error);
  ...
  async validateProfile(userId: string): Promise<ProfileValidation> {
    try {
      ...
      console.error(`Erro ao validar perfil ${userId}:`, error);
  ...
  async updatePrivacySettings(userId: string, settings: PrivacySettings): Promise<PrivacySettings> {
    try {
      ...
      console.error(`Erro ao atualizar configurações de privacidade ${userId}:`, error);
  ...
  async getPrivacySettings(userId: string): Promise<PrivacySettings> {
    try {
      ...
      console.error(`Erro ao obter configurações de privacidade ${userId}:`, error);
  ...
  async updateNotificationSettings(userId: string, settings: NotificationSettings): Promise<NotificationSettings> {
    try {
      ...
      console.error(`Erro ao atualizar configurações de notificações ${userId}:`, error);
  ...
  async getNotificationSettings(userId: string): Promise<NotificationSettings> {
    try {
      ...
      console.error(`Erro ao obter configurações de notificações ${userId}:`, error);
  ...
  async followUser(userId: string, targetUserId: string): Promise<void> {
    try {
      ...
      console.error(`Erro ao seguir usuário ${targetUserId}:`, error);
  ...
  async unfollowUser(userId: string, targetUserId: string): Promise<void> {
    try {
      ...
      console.error(`Erro ao deixar de seguir usuário ${targetUserId}:`, error);
  ...
  async getFollowers(userId: string, params: {
    ...
    try {
      ...
      console.error(`Erro ao obter seguidores do usuário ${userId}:`, error);
  ...
  async getFollowing(userId: string, params: {
    ...
    try {
      ...
      console.error(`Erro ao obter usuários seguidos pelo usuário ${userId}:`, error);
  ...
  async isFollowing(userId: string, targetUserId: string): Promise<boolean> {
    try {
      ...
      console.error(`Erro ao verificar se usuário ${userId} segue ${targetUserId}:`, error);
      return false;
    }
  }
