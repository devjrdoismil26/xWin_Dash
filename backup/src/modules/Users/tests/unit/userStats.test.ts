...
describe('User Stats Operations', () => {
  ...
  describe('userStatsService', () => {
    it('deve buscar estatísticas gerais', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith('/api/users/stats/general');
    ...
    it('deve buscar estatísticas de atividade', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith('/api/users/stats/activity');
    ...
    it('deve buscar estatísticas de geolocalização', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith('/api/users/stats/geolocation');
    ...
    it('deve buscar estatísticas de dispositivos', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith('/api/users/stats/devices');
