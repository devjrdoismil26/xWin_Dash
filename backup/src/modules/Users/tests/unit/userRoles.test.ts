...
describe('User Roles Operations', () => {
  ...
  describe('userRolesService', () => {
    it('deve atribuir role a usuário', async () => {
      ...
      expect(mockApiClient.post).toHaveBeenCalledWith(`/api/users/${userId}/roles`, { role_id: roleId });
    ...
    it('deve remover role de usuário', async () => {
      ...
      expect(mockApiClient.delete).toHaveBeenCalledWith(`/api/users/${userId}/roles/${roleId}`);
      expect(result.success).toBe(true);
    });
    ...
    it('deve buscar roles de um usuário', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith(`/api/users/${userId}/roles`);
    ...
    it('deve verificar se usuário tem role', async () => {
      ...
      expect(mockApiClient.get).toHaveBeenCalledWith(`/api/users/${userId}/roles/${roleName}/check`);
    ...
    it('deve atualizar roles de usuário', async () => {
      ...
      expect(mockApiClient.put).toHaveBeenCalledWith(`/api/users/${userId}/roles`, { roles });
      expect(result.success).toBe(true);
    });
  });
});