...
const StatsIndex: React.FC<{ auth?: any; stats?: any }> = ({ auth, stats }) => {
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Acompanhe o desempenho do seu atendimento</p>
            </div>
          ...
          {/* Chart */}
          <AuraStatsChart period={selectedPeriod} />
        </div>
      </PageLayout>
