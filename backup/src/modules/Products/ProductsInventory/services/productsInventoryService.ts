...
export const fetchAllInventory = async (filters?: any): Promise<ProductResponse> => {
  try {
...
export const fetchInventoryHistory = async (productId: string, filters?: any): Promise<ProductResponse> => {
  try {
...
export const fetchInventoryMovements = async (filters?: any): Promise<ProductResponse> => {
  try {
...
export const fetchInventoryAlerts = async (filters?: any): Promise<ProductResponse> => {
  try {
...
export const fetchStockLevels = async (filters?: any): Promise<ProductResponse> => {
  try {
...
export const generateInventoryReport = async (filters?: any): Promise<ProductResponse> => {
  try {
...
export const exportInventoryData = async (format: 'csv' | 'xlsx' | 'pdf', filters?: any): Promise<ProductResponse> => {
  try {
