...
import {
  ...
  updateCacheStrategy,
  getCacheStrategy
} from '../services/productsOptimizationService';
...
interface UseProductsOptimizationReturn {
  ...
  getConfig: () => any;
  updateStrategy: (key: string, strategy: any) => void;
  getStrategy: (key: string) => any;
...
export const useProductsOptimization = (): UseProductsOptimizationReturn => {
  ...
  const updateStrategy = useCallback((key: string, strategy: any) => {
