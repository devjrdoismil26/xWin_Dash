// =========================================
// SERVIÇO DE CACHE - SOCIAL BUFFER
// =========================================
...
class SocialCacheService {
   ...
   */
  setSocialAccounts(data: any, ttl?: number): void {
    this.set('social-accounts', data, ttl);
  }

  getSocialAccounts(): any | null {
   ...
   * Cache para posts
   */
  setSocialPosts(data: any, ttl?: number): void {
    this.set('social-posts', data, ttl);
  }

  getSocialPosts(): any | null {
   ...
   */
  setSocialSchedules(data: any, ttl?: number): void {
    this.set('social-schedules', data, ttl);
  }

  getSocialSchedules(): any | null {
   ...
   * Cache para hashtags
   */
  setSocialHashtags(data: any, ttl?: number): void {
    this.set('social-hashtags', data, ttl);
  }

  getSocialHashtags(): any | null {
   ...
   */
  setSocialLinks(data: any, ttl?: number): void {
    this.set('social-links', data, ttl);
  }

  getSocialLinks(): any | null {
   ...
   * Cache para mídia
   */
  setSocialMedia(data: any, ttl?: number): void {
    this.set('social-media', data, ttl);
  }

  getSocialMedia(): any | null {
   ...
   */
  setSocialAnalytics(data: any, ttl?: number): void {
    this.set('social-analytics', data, ttl);
  }

  getSocialAnalytics(): any | null {
   ...
   */
  setSocialEngagement(data: any, ttl?: number): void {
    this.set('social-engagement', data, ttl);
  }

  getSocialEngagement(): any | null {
