        ...
        <div className="flex space-x-2">
          <Select value={selectedAccountId} onValueChange={setSelectedAccountId}>
            ...
            <SelectContent>
              ...
              <SelectItem value="4">LinkedIn Account</SelectItem>
            </SelectContent>
          </Select>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Card>
                ...
                <Card.Content>
                  ...
                  <div className="flex items-center gap-1 text-xs text-muted-foreground">
                    {getTrendIcon(analytics.performance.followersGrowth)}
                    <span className={getTrendColor(analytics.performance.followersGrowth)}>
                      {analytics.performance.followersGrowth > 0 ? '+' : ''}{analytics.performance.followersGrowth.toFixed(1)}%
                    </span>
                  </div>
                </Card.Content>
              </Card>
              ...
              <Card>
                ...
                <Card.Content>
                  ...
                  <div className="flex items-center gap-1 text-xs text-muted-foreground">
                    {getTrendIcon(analytics.performance.engagementGrowth)}
                    <span className={getTrendColor(analytics.performance.engagementGrowth)}>
                      {analytics.performance.engagementGrowth > 0 ? '+' : ''}{analytics.performance.engagementGrowth.toFixed(1)}%
                    </span>
                  </div>
                </Card.Content>
              </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card>
                ...
                <Card.Content>
                  ...
                  <div className="flex items-center gap-1 text-xs text-muted-foreground">
                    {getTrendIcon(analytics.performance.reachGrowth)}
                    <span className={getTrendColor(analytics.performance.reachGrowth)}>
                      {analytics.performance.reachGrowth > 0 ? '+' : ''}{analytics.performance.reachGrowth.toFixed(1)}%
                    </span>
                  </div>
                </Card.Content>
              </Card>
              ...
              <Card>
                ...
                <Card.Content>
                  ...
                  <div className="flex items-center gap-1 text-xs text-muted-foreground">
                    {getTrendIcon(analytics.performance.impressionsGrowth)}
                    <span className={getTrendColor(analytics.performance.impressionsGrowth)}>
                      {analytics.performance.impressionsGrowth > 0 ? '+' : ''}{analytics.performance.impressionsGrowth.toFixed(1)}%
                    </span>
                  </div>
                </Card.Content>
              </Card>
              ...
              <Card>
                ...
                <Card.Content>
                  <div className="text-center">
                    <div className="text-4xl font-bold mb-2">{analytics.performance.performanceScore.toFixed(1)}</div>
                  ...
                  <Card.Content>
                    {analytics.performance.bestPerformingPost ? (
                      <div className="space-y-2">
                        <div className="text-sm line-clamp-2">{analytics.performance.bestPerformingPost.content}</div>
                        <div className="flex items-center gap-2">
                          <Badge className={getPlatformColor(analytics.performance.bestPerformingPost.platform)}>
                            {analytics.performance.bestPerformingPost.platform}
                          </Badge>
                          <span className="text-sm font-medium">
                            {formatNumber(analytics.performance.bestPerformingPost.metrics.engagement)} engagement
                          </span>
                        </div>
                      </div>
                    ) : (
            ...
            <Card>
              ...
              <Card.Content>
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">Showing performance trends for {analytics.accountName}</p>
                </div>
              </Card.Content>
            </Card>
          </TabsContent>
