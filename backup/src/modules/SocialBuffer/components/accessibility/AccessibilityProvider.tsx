...
export const AccessibilityProvider: React.FC<AccessibilityProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    mediaQueries.reducedMotion.addEventListener('change', (e) => setReducedMotion(e.matches));
    mediaQueries.highContrast.addEventListener('change', (e) => setHighContrast(e.matches));
    mediaQueries.colorScheme.addEventListener('change', (e) => 
    ...
    // Cleanup
    return () => {
      mediaQueries.reducedMotion.removeEventListener('change', (e) => setReducedMotion(e.matches));
      mediaQueries.highContrast.removeEventListener('change', (e) => setHighContrast(e.matches));
      mediaQueries.colorScheme.removeEventListener('change', (e) => 
        setColorScheme(e.matches ? 'dark' : 'light')
      );
