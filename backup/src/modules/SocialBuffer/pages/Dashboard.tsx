...
const Dashboard: React.FC<{ auth?: any }> = ({ auth }) => {
  ...
  const totalEngagement = publishedPosts.reduce((sum, post) => sum + (post.engagement || 0), 0);
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Visão geral do seu Social Buffer</p>
            </div>
              ...
              <Card.Content className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-orange-600">+3% vs período anterior</p>
                  </div>
                    ...
                    {upcomingPosts.map((post) => (
                      <div key={post.id} className="flex items-center justify-between p-3 border rounded-lg">
                        <div className="flex-1">
                          <p className="font-medium text-sm line-clamp-1">{post.title || 'Sem título'}</p>
                  ...
                  {topPosts.map((post, index) => (
                    <div key={post.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="font-medium">{post.title || 'Sem título'}</h3>
