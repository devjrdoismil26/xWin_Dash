// =========================================
// SOCIAL ENGAGEMENT STORE - SOCIAL BUFFER
// =========================================
...
interface SocialEngagementActions {
  ...
  startMonitoring: (postId: string, settings?: any) => Promise<void>;
  stopMonitoring: (postId: string) => Promise<void>;
  getMonitoringStatus: (postId: string) => Promise<void>;
  updateMonitoringSettings: (postId: string, settings: any) => Promise<void>;
  listMonitoredPosts: (params?: any) => Promise<void>;
  
  // Ações de alertas
  getEngagementAlerts: (params?: any) => Promise<void>;
  markAlertAsRead: (alertId: string) => Promise<void>;
  markAllAlertsAsRead: () => Promise<void>;
  deleteAlert: (alertId: string) => Promise<void>;
  
  // Ações de interações
  getPostInteractions: (postId: string, params?: any) => Promise<void>;
  getAllInteractions: (params?: any) => Promise<void>;
  
  // Ações de comentários
  getPostComments: (postId: string, params?: any) => Promise<void>;
  ...
  getPostShares: (postId: string, params?: any) => Promise<void>;
  ...
  analyzeEngagementByPeriod: (params: any) => Promise<void>;
  
  // Ações de insights
  getEngagementInsights: (params: any) => Promise<void>;
  getInsightsByType: (type: string, params: any) => Promise<void>;
  
  // Ações de previsões
  forecastPostEngagement: (postId: string) => Promise<void>;
  forecastEngagementByContent: (content: any) => Promise<void>;
  
  // Ações de seleção
  selectPost: (postId: string | null) => void;
  selectAlerts: (alertIds: string[]) => void;
  clearSelection: () => void;
  
  // Ações de filtros
  setFilters: (filters: Partial<EngagementParams>) => void;
  clearFilters: () => void;
  ...
  devtools(
    persist(
      (set, get) => ({
        ...
        startMonitoring: async (postId: string, settings?: any) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao iniciar monitoramento',
              monitoring: false
            });
          }
        },
        ...
        stopMonitoring: async (postId: string) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao parar monitoramento',
              monitoring: false
            });
          }
        },
        ...
        getMonitoringStatus: async (postId: string) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao buscar status de monitoramento',
              monitoring: false
            });
          }
        },
        
        updateMonitoringSettings: async (postId: string, settings: any) => {
          set({ monitoring: true, error: null });
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao atualizar configurações de monitoramento',
              monitoring: false
            });
          }
        },
        
        listMonitoredPosts: async (params?: any) => {
          set({ loading: true, error: null });
          
          try {
            const response = await engagementService.listMonitoredPosts(params);
            set({
              monitoredPosts: response.data,
              loading: false,
              lastFetch: { ...get().lastFetch, monitoring: Date.now() }
            });
          } catch (error) {
            set({
              error: error instanceof Error ? error.message : 'Erro ao listar posts em monitoramento',
              loading: false
            });
          }
        },
        ...
        getEngagementAlerts: async (params?: any) => {
          set({ loading: true, error: null });
          
          try {
            const response = await engagementService.getEngagementAlerts(params);
            set({
              engagementAlerts: response.data,
              loading: false
            });
          } catch (error) {
            set({
              error: error instanceof Error ? error.message : 'Erro ao buscar alertas de engajamento',
              loading: false
            });
          }
        },
        ...
        markAlertAsRead: async (alertId: string) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao marcar alerta como lido',
              loading: false
            });
          }
        },
        ...
        markAllAlertsAsRead: async () => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao marcar todos os alertas como lidos',
              loading: false
            });
          }
        },
        ...
        deleteAlert: async (alertId: string) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao deletar alerta',
              loading: false
            });
          }
        },
        ...
        getPostInteractions: async (postId: string, params?: any) => {
          set({ fetchingInteractions: true, error: null });
          
          try {
            const response = await engagementService.getPostInteractions(postId, params);
            set(state => ({
              postInteractions: { ...state.postInteractions, [postId]: response.data },
              fetchingInteractions: false,
              lastFetch: { ...state.lastFetch, interactions: Date.now() }
            }));
          } catch (error) {
            set({
              error: error instanceof Error ? error.message : 'Erro ao buscar interações do post',
              fetchingInteractions: false
            });
          }
        },
        
        getAllInteractions: async (params?: any) => {
          set({ fetchingInteractions: true, error: null });
          
          try {
            const response = await engagementService.getAllInteractions(params);
            set({
              postInteractions: response.data.reduce((acc, interaction) => {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao buscar todas as interações',
              fetchingInteractions: false
            });
          }
        },
        ...
        getPostComments: async (postId: string, params?: any) => {
          ...
          try {
            ...
            set(state => ({
              postComments: { ...state.postComments, [postId]: response.data },
              fetchingInteractions: false
            }));
          } catch (error) {
            set({
              error: error instanceof Error ? error.message : 'Erro ao buscar comentários do post',
              fetchingInteractions: false
            });
          }
        },
        ...
        likeComment: async (commentId: string) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao curtir comentário',
              loading: false
            });
          }
        },
        ...
        getPostReactions: async (postId: string) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao buscar reações do post',
              fetchingInteractions: false
            });
          }
        },
        ...
        removeReaction: async (postId: string, reactionType: string) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao remover reação',
              loading: false
            });
          }
        },
        ...
        getPostShares: async (postId: string, params?: any) => {
          set({ fetchingInteractions: true, error: null });
          
          try {
            const response = await engagementService.getPostShares(postId, params);
            set(state => ({
              postShares: { ...state.postShares, [postId]: response.data },
              fetchingInteractions: false
            }));
          } catch (error) {
            set({
              error: error instanceof Error ? error.message : 'Erro ao buscar compartilhamentos do post',
              fetchingInteractions: false
            });
          }
        },
        ...
        sharePost: async (postId: string, shareType: string, message?: string) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao compartilhar post',
              loading: false
            });
          }
        },
        ...
        analyzePostEngagement: async (postId: string) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao analisar engajamento do post',
              analyzing: false
            });
          }
        },
        ...
        analyzeMultiplePosts: async (postIds: string[]) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao analisar engajamento de múltiplos posts',
              analyzing: false
            });
          }
        },
        
        analyzeEngagementByPeriod: async (params: any) => {
          set({ analyzing: true, error: null });
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao analisar engajamento por período',
              analyzing: false
            });
          }
        },
        ...
        getEngagementInsights: async (params: any) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao buscar insights de engajamento',
              generatingInsights: false
            });
          }
        },
        
        getInsightsByType: async (type: string, params: any) => {
          set({ generatingInsights: true, error: null });
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao buscar insights por tipo',
              generatingInsights: false
            });
          }
        },
        ...
        forecastPostEngagement: async (postId: string) => {
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao prever engajamento do post',
              forecasting: false
            });
          }
        },
        
        forecastEngagementByContent: async (content: any) => {
          set({ forecasting: true, error: null });
          ...
          try {
            ...
            set({
              error: error instanceof Error ? error.message : 'Erro ao prever engajamento por conteúdo',
              forecasting: false
            });
          }
        },
