/**
 * Configuração unificada de tema para xWin Dash
 * Centraliza todas as definições de cores, espaçamentos e variantes
 */
 ...
 */
export const getThemeClasses = (baseClasses: string, variant: 'light' | 'dark' = 'light') => {
  ...
  return baseClasses
    ...
    .replace(/border-gray-300/g, isDark ? 'border-gray-600' : 'border-gray-300');
};
...
export const COMMON_CLASSES = {
  ...
  button: {
    ...
    outline: 'border border-gray-300 text-gray-700 bg-transparent hover:bg-gray-50 focus:ring-blue-500 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700',
    ghost: 'text-gray-700 bg-transparent hover:bg-gray-100 focus:ring-gray-500 dark:text-gray-300 dark:hover:bg-gray-700'
  },
  ...
  card: {
    ...
    elevated: 'bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600 rounded-xl shadow-sm hover:shadow-md transition-all duration-250 ease-in-out hover:-translate-y-1'
  },
